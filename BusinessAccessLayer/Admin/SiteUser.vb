...
#Region "Variables"
        ...
        Private _strSearch As String = String.Empty
...
#Region "SearchUsers"
        Public Function SearchUsers() As DataSet
            Try
                'Dim objEncDec As New Utility
                Dim dataAccess As New DALDataAccess()
                Dim ds As New DataSet
                dataAccess.AddCommand(CommandType.StoredProcedure, "prc_SearchUser")
                dataAccess.AddParam("@SearchKey", SqlDbType.NVarChar, ParamString(Me.Search))
                ds = dataAccess.GetDataset()
                Return ds
