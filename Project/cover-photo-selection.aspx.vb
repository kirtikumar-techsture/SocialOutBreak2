...
Public Class cover_photo_selection
    ...
    Private Sub lnkSave_ServerClick(sender As Object, e As System.EventArgs) Handles lnkSave.ServerClick
        ...
        Try
            If Session("FacebookAccessToken") <> Nothing AndAlso Session("FacebookAccessToken") <> "" Then
                ...
                'Response.Write(CInt(dsID.Tables(0).Rows(0).Item("IDNew").ToString))
                'Response.End()
    ...
    Private Sub lnkRedirect_ServerClick(sender As Object, e As System.EventArgs) Handles lnkRedirect.ServerClick
        Response.Redirect("cover-photo-selection-edit.aspx?cpId=" & Session("CoverPhotoID") & "&userId=" & CInt(Request.QueryString("userId")) & "&FbuserId=" & Request.QueryString("FbuserId") & "&CId=" & Request.QueryString("CId") & "&IId=" & Request.QueryString("IId"))
    End Sub
    ...
    Private Sub lnkShareUserEmail_ServerClick(sender As Object, e As System.EventArgs) Handles lnkShareUserEmail.ServerClick
        Try
            If Session("FacebookAccessToken") <> Nothing AndAlso Session("FacebookAccessToken") <> "" Then
                ...
                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "ShareAlert", "ShareAlert('Cover Photo shared succefully');", True)
                hdnPublished.Value = "0"
