<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tabs-list.aspx.vb" Inherits="tsma.tabs_list" %>
                                            ...
                                            <td align="center" style="border:1px solid #ced5e5; padding-top:29px; padding-bottom:29px;"><asp:DataList ID="rptPaging" runat="server" RepeatColumns="1" RepeatDirection="Vertical">
                                                <ItemTemplate>
                                                  <table align="center">
                                                    <tr>
                                                       <td valign="top">
                                                        <div style="font-family: Tahoma, Geneva, sans-serifthaoma; font-size: 14px; color: #181818; font-weight:bold; text-align:center; "><%#Container.DataItem("ctl_Name")%></div><br />
                                                        <a href='selection.aspx?ctId=<%#container.dataitem("ctl_id")%>&cId=<%#request("cid")%>&isCustomise=<%#container.dataitem("ctl_isCustomise")%>'><img  alt="" src='Content/images/customtab/<%#Container.DataItem("ctl_Image") %>' border="0"/></a>
...
Scroll Mouse To Rotate Templates
    ...
    <br />
                                  ...
                                  <asp:Repeater ID="rptCustomTab" runat="server">
                                    <ItemTemplate>
                                      <%--<a id="lnkSidebar" href="javascript:;" onclick='ShowHideDiv(<%#Container.DataItem("ctl_Id") %>)'><img  alt="" width="1000px" src='Content/images/<%#Container.DataItem("ctl_Image") %>' border="0"/></a>--%>
                                        <%--<a id="lnkSidebar" onclick="ShowHideDiv()" href="sidebar_selection.aspx?sdId=<%#Container.DataItem("sdm_Id") %>&userId=<%#Container.DataItem("sdm_UserId")%>&FbuserId=&CId=<%#Container.DataItem("sdm_CompanyId")%>&IId=<%#Container.DataItem("sdm_IndustryId")%>"><img  alt="" src='Content/images/<%#Container.DataItem("sdm_Image") %>' border="0"/></a>--%>
                                         <div style="cursor:pointer;" title='Click here to select this template.' id='<%#Container.DataItem("ctl_Id") %>'>
                                         <div style="font-family: Tahoma, Geneva, sans-serifthaoma; font-size: 14px; color: #181818; font-weight:bold; text-align:center; "><%#Container.DataItem("ctl_Name")%></div><br />
											<a href='selection.aspx?ctId=<%#container.dataitem("ctl_id")%>&cId=<%#request("cid")%>&isCustomise=<%#container.dataitem("ctl_isCustomise")%>'><img alt="" src='Content/images/customtab/<%#Container.DataItem("ctl_Image") %>' border="0"/>
                                            </a>
										 </div>
                      ...
                      <table id="trNoPaging" width="100%" style="display:;" align="center" border="0" cellpadding="0" cellspacing="0">
                                          <tr>
                                            <td align="center" style="border:1px solid #ced5e5; border-bottom:0px; padding-top:29px; padding-bottom:29px; padding-right:20px;"><asp:DataList ID="rptNoPaging" runat="server" RepeatColumns="1" RepeatDirection="Horizontal">
                                                <ItemTemplate>
                                                  <table align="center">
                                                    <tr>
                                                      <td style="padding-bottom:20px;" valign="top">
                                                       <div style="font-family: Tahoma, Geneva, sans-serifthaoma; font-size: 14px; color: #181818; font-weight:bold; text-align:center; "><%#Container.DataItem("ctl_Name")%></div><br />
                                                    <a href='selection.aspx?ctId=<%#container.dataitem("ctl_id")%>&cId=<%#request("cid")%>&isCustomise=<%#container.dataitem("ctl_isCustomise")%>'><img  alt="" src='Content/images/customtab/<%#Container.DataItem("ctl_Image") %>' border="0"/></a><br />
