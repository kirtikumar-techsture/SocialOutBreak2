<%@ Page Language="vb" AutoEventWireup="false" ValidateRequest="false" CodeBehind="scheduler-new.aspx.vb" Inherits="tsma.scheduler_new" %>
...
<!-- saved from url=(0032)https://so.tsmaapplication.com/ -->
...
<script src="<%=ResolveUrl("~/Content/js/fancybox/fancybox/video.js") %>" type="text/javascript"></script>
<link href="<%=ResolveUrl("~/Content/js/fancybox/fancybox/jquery.fancybox-1.3.4.css")%>" rel="stylesheet" type="text/css" media="screen" />
<script src="<%=ResolveUrl("~/Content/js/fancybox/fancybox/jquery.fancybox-1.3.4.pack.js")%>" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            var to = setTimeout("showDiv()", 20000);
        });
...
<div id="DivSaveScheduler" style="width:100%; height:1450px; text-align:center; background-image:url(../Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center; padding-left:150px;  display:none;">
			  <div id="popup_container1" style="width:450px;">
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                   ...
                   <a href="../scheduler-main" id="lnkSchduler" class="bluetablink">Save</a>
				</div>
			 </div>
	</div>
...
<div id="DivError" style="width:100%; height:1450px; text-align:center; background-image:url(../Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center; padding-left:150px;  display:none;">
			  <div id="popup_container1" style="width:450px;">
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                   ...
                   <a href="javascript:;" id="lnkSchduler" onclick="$('#DivError').hide('slow');" class="bluetablink">Close</a>
				</div>
			 </div>
	</div>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="left" valign="top" class="contentbody" style="padding-left:10px; padding-right:10px;"><div style="padding-bottom:10px;">
              ...
              <span style="float:left;font-family: Tahoma, Geneva, sans-serifthaoma;font-size: 16px;color: #181818;margin:0px;font-weight:bold;line-height:18px;"> Schedule Post</span>
            <div id="divWatch" style="float:right;padding-bottom:10px; display:none;" >
            <a id="btnVideo" href="https://www.youtube.com/watch?v=nIL5GwC6u7o"  title="How to Quick Post & Schedule Content" class="video" >
            <img id="imgVideo"  src='../Content/images/watch_video_tutorial_red.jpg'  style="width:213px;height:36px"/></a>
            </div>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                              ...
                              <td align="left" valign="top" style="padding:7px; font-family:arial;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td align="left" style="padding-top:10px;"><strong>Select an image file on your computer.</strong><br />
                                      <input name="source" type="file" id="photo" width="200" onchange="readImageLoad(this);" runat="server"/>&nbsp;&nbsp;<a href="javascript:;" id="lnkFileRemove" style="display:none; padding-left:5px;" onclick="RemoveFileUploadImage();">Remove</a>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                              	<td align="left" valign="top" style="padding-top:20px;">
                                	<asp:Label id="lblFanPageMessage" runat="server"></asp:Label>
                                </td>
                              </tr>
                              <tr>
                                      ...
                                      <table width="230" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                          <td width="48" align="left" valign="middle" style="background-color:#f6f6f6; " ><table border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                <td align="center" valign="middle"><img width="40" style=" border: 7px solid #f6f6f6" height="40" align="absmiddle" group="pageimg"  /> </td>
                                                <td align="center" valign="middle"><table border="0" width="170" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      <td width="25" align="left" valign="middle" style="text-align:center; vertical-align:middle"><input class="checkboxpadding" type="checkbox" id="chkPage" name="chkPage" runat="server" group="pages" onClick="checkAll(document.form1.chkPage)"/></td>
                                                      <td align="left" width="150" valign="middle">Select All
                ...
                <td align="left" valign="middle" class="popupinnerbg" style="border:1px solid #b4bbcd;  border-top:0px; "><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td align="left" valign="top" style="border:1px solid #eaeaea;"><div id="divLibCat" style="display:none; z-index:100; position:absolute; border:1px solid #eaeaea; background-color:#FFFFFF; padding:10px; width:160px;">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td align="right" valign="top"><a href="javascript:;" class="lib_close"><img src='../Content/images/delete_icon.png' hspace="7" vspace="7" border="0"/></a></td>
                            </tr>
                            <tr>
              ...
              <tr>
                ...
                <td height="30" align="left" valign="middle" style="padding-top:10px; padding-bottom:10px;"><div id="divHtml" runat="server" style="width:300px; display:none; height:auto; border:1px solid #eaeaea; background-color:#f6f6f6; padding:15px; line-height:22px;"> </div></td>
              </tr>
              <tr>
                <td align="left"></td>
              </tr>
              <tr>
                ...
                <div id="TabbedPanels1" class="TabbedPanels" >
                    <ul class="TabbedPanelsTabGroup" style="padding-left:27px;">
					  ...
					  <%=tsma.GetSetCookies.GetCookie("SelectedName")%>
                                                            ...
                                                            <tr>
                                                              ...
                                                              <div id="divAdminLibVideo" visible='<%#DataBinder.Eval(Container.DataItem, "lib_VideoId")<>""%>' runat="server" style="padding-bottom:10px; padding-right:15px;">
                                                                ...
                                                                <span id='spnlib<%#Eval("lib_Id")%>'>
                                                                 <%#Eval("lib_Template")%></span><br/><%#Eval("lib_Link")%>
                                                                  <input type="hidden" id="hdnlib<%#Eval("lib_Id")%>" value='<%#Eval("lib_Image")%>' />
                                                              <input type="hidden" id="hdnlibVideo<%#Eval("lib_Id")%>" value='<%#Eval("lib_Link")%>' />&nbsp;
                                                                </td>
                                                            </tr>
                                                            <tr>
                                          ...
                                          <asp:Repeater id="rptUserLibCatTitle" runat="server">
                                            <itemtemplate>
                                               ...
                                               <asp:PlaceHolder ID="pnlLibCatDel" runat="server" Visible='<%#Eval("lc_UserId")<>-1%>'>
                                                      <asp:LinkButton OnCommand="DeleteMyLibCat" onclientclick="return Prompt('Are you sure you want to delete this library?');" CommandArgument='<%#Eval("Id")%>' CommandName='<%#Eval("Title")%>' id="lnkAdminLibCatDelete" runat="server"><img src='../Content/images/delete_icon.png' border="0"/></asp:LinkButton>
                                                    </asp:PlaceHolder>
                                                    </td>
                                          </itemtemplate>
                                          </asp:Repeater>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <tr>
                                                              ...
                                                              <div id="divUserLibVideo" visible='<%#DataBinder.Eval(Container.DataItem, "lib_VideoId")<>""%>' runat="server" style="padding-bottom:10px; padding-right:15px;">
                                                                ...
                                                                <span id='spnlib<%#Eval("lib_Id")%>'> <%#Eval("lib_Template")%></span><br/><%#Eval("lib_Link")%>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                              ...
                                                              <input type="hidden" id="hdnlibVideo<%#Eval("lib_Id")%>" value='<%#Eval("lib_Link")%>' /></td>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      <td align="left" valign="top" width="100" style="display:<%#iif(Eval("sm_Image")<>"" or Eval("sm_VideoId")<>"" ,"","none")%>"><div id="divScheduleImage" runat="server" style="padding-top:15px; padding-right:15px;"> <img id="imgSchedulePhoto" runat="server"  border="0" class="grayborder" onMouseOver="ShowDiv('divScheduleLargeImage');" onMouseOut="HideDiv('divScheduleLargeImage');"/> </div>
                                                          
                                                      ...
                                                      <td align="left" valign="top" style="padding:15px 0px; text-align:left; color:#676767; line-height:17px;">
                                                      <input type="hidden" id="hdnScheduledPostId" runat="server" value='<%# DataBinder.Eval(Container.DataItem, "sm_id")%>'>
                                                        <%#DataBinder.Eval(Container.DataItem, "sm_Message")%><br/>
                                              <a href='<%#DataBinder.Eval(Container.DataItem, "sm_Link")%>' target="_blank"><%#DataBinder.Eval(Container.DataItem, "sm_Link")%></a></td>
                                                    </tr>
                                                  </table></td>
                                              </tr>
                                              <tr>
                                                ...
                                                <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      ...
                                                      <a href='../scheduler-main/<%# Container.DataItem("sm_Id")%>' style="text-decoration:none;" title="Edit"><img src="../Content/images/icon_edit.gif" hspace="7" border="0" /></a>
                                                        <asp:ImageButton ImageUrl="Content/images/icon_delet.gif" OnClick="DeleteByID" CommandArgument="2" CommandName='<%#DataBinder.Eval(Container.DataItem, "sm_Id")%>' OnClientClick="return confirm('Are you sure want to delete this Scheduled Post?');"  ID="btndelete" runat="server" ToolTip="Delete" />
                                                        </asp:ImageButton>
                                                      </td>
                                                    </tr>
                                                  </table></td>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <div id="divSentVideo" visible='<%#DataBinder.Eval(Container.DataItem, "sm_VideoId")<>""%>' runat="server" style="padding-bottom:10px; padding-right:15px;">
                                              <object style="height:100px; width: 100px">
                                                ...
                                                <embed src='<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>' type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always" width="100" height="100">
                                                      ...
                                                      <td align="left" valign="top" style="padding:15px 0px; text-align:left; color:#676767; line-height:17px;"> 
                                                      <input type="hidden" id="hdnSentItemId" runat="server" value='<%# DataBinder.Eval(Container.DataItem, "sm_id")%>'>
                                              <%#DataBinder.Eval(Container.DataItem, "sm_Message")%><br/>
                                              <a href='<%#DataBinder.Eval(Container.DataItem, "sm_Link")%>' target="_blank">
											  <%#DataBinder.Eval(Container.DataItem, "sm_Link")%></a></td>
                                                    </tr>
                                                  </table></td>
                                              </tr>
                                              <tr>
                                            ...
                                            <%--<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleDate")%> , <%#DataBinder.Eval(Container.DataItem, "sm_ScheduleHour")%>:<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleMinute")%>&nbsp;<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleAMPM")%>--%></td>
                                                      <td align="right" valign="top">
                                                      <a href='../scheduler-main/<%# Container.DataItem("sm_Id")%>' style="text-decoration:none;" title="Edit"><img src="../Content/images/icon_edit.gif"  hspace="7" border="0" /></a>
                                                      <asp:ImageButton ImageUrl="Content/images/icon_delet.gif" OnClick="DeleteByID" CommandArgument="3" CommandName='<%#DataBinder.Eval(Container.DataItem, "sm_Id")%>' OnClientClick="return confirm('Are you sure want to delete this post?');"  ID="btndelete" runat="server" ToolTip="Delete" />
                                              </asp:ImageButton>
                                                      </td>
                                                    </tr>
                                                  </table></td>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <div id="divDraftVideo" visible='<%#DataBinder.Eval(Container.DataItem, "sm_VideoId")<>""%>' runat="server" style="padding-bottom:10px; padding-right:15px;">
                                              <object style="height: 100px; width: 100px">
                                                ...
                                                <embed src='<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>' type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always" width="100" height="100" />
                                                      ...
                                                      <td align="left" valign="top" style="padding:15px 0px; text-align:left; color:#676767; line-height:17px;"> 
                                                      <input type="hidden" id="hdnDraftId" runat="server" value='<%# DataBinder.Eval(Container.DataItem, "sm_id")%>'>
                                              <%#DataBinder.Eval(Container.DataItem, "sm_Message")%><br/>
                                              <a href='<%#DataBinder.Eval(Container.DataItem, "sm_Link")%>' target="_blank"><%#DataBinder.Eval(Container.DataItem, "sm_Link")%></a></td>
                                                    </tr>
                                                  </table></td>
                                            ...
                                            <%--<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleDate")%> , <%#DataBinder.Eval(Container.DataItem, "sm_ScheduleHour")%>:<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleMinute")%>&nbsp;<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleAMPM")%>--%>
                                                      ...
                                                      <td align="right" valign="top"><a href='../scheduler-main/<%# Container.DataItem("sm_Id")%>' style="text-decoration:none" title="Edit"><img src="../Content/images/icon_edit.gif"  hspace="7" border="0" /></a><asp:ImageButton ImageUrl="Content/images/icon_delet.gif" OnClick="DeleteByID" CommandArgument="4" CommandName='<%#DataBinder.Eval(Container.DataItem, "sm_Id")%>' OnClientClick="return confirm('Are you sure want to delete this Drafts?');"  ID="btndelete" runat="server" ToolTip="Delete" />
                                              </asp:ImageButton>
                                                      </td>
                                                    </tr>
                                                  </table></td>
