...
<script type="text/javascript">
    function chkTemplatePage3(mess) {
        ...
        if (test == "1") {
			...
			$('#DivSaveBeforeExistCover').css({'width':maskWidth,'height':maskHeight});		
            $("#spnMessage").html(mess);
            $("#DivSaveBeforeExistCover").show("slow");
            return false;
        }
    }
...
<tr>
  ...
  <div class="watch_video_tut_box" style="padding-top:5px; padding-left:130px;">
  
<asp:PlaceHolder ID="pnlEdit" runat="server">
<table width="608" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left" valign="top" style="padding:13px; padding-top:15PX; border:1px solid #46629e; background-color:#6c84b8"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td align="center" valign="middle" style="vertical-align:middle; line-height:15px; text-align:left; color:#FFFFFF; border-left:2px solid #bdc7d8; padding-left:10px;">To edit the text, click the Edit Text button. To customize the background <br />
              and color or add an image, click the Edit Color & Images button. Text may look a little different on download.</td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td height="34" align="right" valign="top" ><a  href="#" class="nav-action-button rc-m rm-css-control-close" title="Watch Video Tutorial" onclick="$('#helptext1').fadeIn();"><img src="Content/images/watch_video_tutorial.gif" width="158" height="24" border="0" /></a></td>
      </tr>
      <tr>
      ...
      <tr>
        <td style="border:1px solid #46629e; background-color:#FFF; padding-left:20px; padding-top:8px; padding-bottom:8px;"><div id="editor-nav">
          <div class="editor-nav-panel rc-m">
            <div class="editor-nav-panel-content">
              ...
              <a id="rm-content-launch"  href="#launch-content" class="nav-action-button rc-m rm-css-control-close" title="Edit text content"><img src="Content/images/edit_text_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Edit Text</a> 
              <a id="rm-css-launch" href="#launch-css" class="nav-action-button rc-m " title="Edit Appearance of the Presentation!"><img src="Content/images/edit_color_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Edit Color & Images</a> 
              <a id="ch_temp"  href="javascript:;" target="_parent" class="nav-action-button rc-m " title="Change Template for this Page." onclick="chkTemplatePage3('Warning! Please Save your work befor leave this page othrewise your changes will be discarded');"><img src="Content/images/change_template_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Change Template</a><a id="lnkResize" runat="server" href="javascript:;" target="_parent" class="nav-action-button rc-m " title="Crop Image" onclick="PopupCenter('crop2.aspx', 'Resize','800','700');"><img src="Content/images/crop_img_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Crop Image</a>
              <a href="javascript:;" onclick="FacebookAlert();" class="nav-action-button rc-m " title="Reset selected template"><img src="Content/images/reset_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Reset</a>
              <a href="#" id="lnkReset" runat="server" style="display:none" ></a>
              <a href="#"  class="nav-action-button rc-m " title="Save CoverPhoto" id="lnkSaveName" runat="server" onclick="SaveCoverPhoto();GetWidthHeight();" ><img src="Content/images/save_icon_sidebar.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Save</a><a href="#" id="lnkSave" runat="server" style="display:none"></a>
              <a id="lnkShare"  href="javascript:;" target="_parent" class="nav-action-button rc-m " title="Share Cover Photo" onclick="$('#DivCoverPhotoUserEmail').show('slow');"><img src="Content/images/share_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Share With User</a>
              <a href="#"  class="nav-action-button rc-m " title="Publish CoverPhoto" id="lnkPublish" runat="server" onclick="PublishCoverPhoto();GetWidthHeight();"><img src="Content/images/publish_custom_tab_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Publish Cover Photo</a>
              ...
              <div style="padding-left:200px; "><img id="imgLoading" src="content/images/bigspinner.gif" style="display:none" /> </div>
  ...
  <tr>
    <td align="center" valign="top"><img src="Content/images/sidebar_arrow_down.png" width="23" height="12" /></td>
  </tr>
</table>
</asp:PlaceHolder>
...
<table width="599" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left" valign="top" style="padding:13px; padding-top:15PX; border:1px solid #46629e; background-color:#6c84b8">							
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center" style="vertical-align:middle; line-height:18px; padding-top:10px; padding-bottom:15px; color:#FFFFFF">
...
<div class="content_div" style="padding-top:20px;">
 <div id="DivSaveCoverPhoto" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
   ...
   <div id="DivCoverPhotoName" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
			  <div id="popup_container1" style="width:450px; height:80px;" >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left;">
                  CoverPhoto Name:  <input type="text" runat="server" id="txtCoverPhotoName" width="100" height="20" /><br/><br/>
                   <input type="button" class="inputbutton" onclick="HideCoverPhotoNameAlert();" style="cursor:pointer" value="Save" id="popup_save" />&nbsp;
                   <input type="button" class="inputbutton" onclick="$('#DivCoverPhotoName').hide('slow')" style="cursor:pointer" value="Cancel" id="popup_cancel" />
				</div>
			 </div>
			 </div>
 <div id="DivCoverPhotoUserEmail" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
			  <div id="popup_container1" style="width:450px; height:80px;" >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left;">
                  Enter User's Primary Email:  <input type="text" runat="server" id="txtUserEmail" width="100" height="20" /><br/><br/>
                     <a href="javascript:;" id="lnkShareUserEmail" runat="server" style="display:" class="bluetablink" onclick="return ValidateUserEmail();">Share</a>&nbsp;&nbsp;
                     <a href="javascript:;" class="bluetablink" onclick='$("#DivCoverPhotoUserEmail").hide("slow");'>Cancel</a>
				</div>
			 </div>
			 </div>
  ...
  <div id="divLib" runat="server" style="margin-right:0px;width:74px;height:40px;overflow:hidden;position:absolute">
    <asp:UpdateProgress ID="UpdateProgressLib" runat="Server" DisplayAfter="0">
      <ProgressTemplate> <img border="0" src="Content/images/ajax-loading.gif" style="border:0px;font-family:Tahoma;font-size:12px;" alt="Loading" /> </ProgressTemplate>
    </asp:UpdateProgress>
  </div>
