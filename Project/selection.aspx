<%@ Page Language="vb" ValidateRequest="false" AutoEventWireup="false" CodeBehind="selection.aspx.vb" Inherits="tsma.selection" %>
...
<%--
    <script src="Content/js/floating-1.12.js" type="text/javascript"></script>--%>
<!--Update End css-->
...
<script type="text/javascript">
    ...
    function OpenDivCustomTabName1() {
//    SaveCustomTab();
//    GetWidthHeight();
//    var maskHeight = $(document).height();
//    var maskWidth = $(window).width();
                ...
                <tr>
                  <td align="left" valign="top" style="padding:13px; padding-top:15PX; border:1px solid #46629e; background-color:#6c84b8; border-left:0px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <a  href="#launch-css" class="nav-action-button rc-m " title="Close full screen" onclick="window.self.close();">Close</a>-->
                            ...
                            <div class="editor-nav-panel rc-m">
                              <div class="editor-nav-panel-content">
                              <a id="lknDownloadBasicCode"  href="#launch-content" style="width:180px;" runat="server" class="nav-action-button rc-m rm-css-control-close" title="Edit text content"><img src="Content/images/edit_text_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Download Basic Code</a>
                              ...
                              <a href="javascript:;"  class="nav-action-button rc-m " style="width:180px;" title="Save CustomTab" id="A5" onclick="return OpenDivCustomTabName1();" ><img src="Content/images/save_icon_sidebar.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Save</a>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td colspan="2" valign="top"><div style="overflow:auto; background-color:#ffffff; padding:15px; border:1px solid #cccccc;">
                          <table cellpadding="0" cellspacing="2" border="0" width="100%">
                            ...
                            <tr>
                              <td  align="left" valign="middle">Please publish your custom tab first then request URLs</td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
      ...
      <tr>
        <td align="left" valign="top">
        <textarea name="textarea" id="txtCustomCode" cols="45" rows="5" class="textarea" runat="server">
        </textarea></td>
      </tr>
      <tr>
        <td align="left" valign="top">&nbsp;</td>
      ...
      <tr>
        <td align="right" valign="top" style="border-bottom:1px solid #d9dbde; padding-bottom:20px;">
        <a href="javascript:;" id="SaveCode" class="bluetablink" onclick="SavePasteCode();">Save and Close</a></td>
      </tr>
      <tr>
        <td align="left" valign="top">&nbsp;</td>
      </tr>
