...
<script type="text/javascript">
     function chkTemplatePage3(mess) {
			...
			{	
				...
				window.parent.location.href= '<%=strPageReturnCatId%>';
				return true;
			}
			else
			{
	...
	line-height:18px; text-align:center">&nbsp;<br />
            ...
            <div class="content_div" style="vertical-align:top;">
              ...
              <!--<asp:UpdatePanel ID="uptMain1" runat="server">
				...
				<div style="height:2300px;" id="dvTabMainDiv" runat="server">
				<div style="float:left; height:2300px;" id="dvTabSubDiv" runat="server">
				<!-- Left Template start -->
				<div  style="float:center; font-family: Tahoma, Geneva, sans-serifthaoma; font-size: 14px; color: #181818; font-weight:bold; text-align:center; ">
                  ...
                  <div align="left" style=" padding-left:10px; ">
                    <div class="side_bar_custom123" style="padding:0px;">
          ...
          <div id="rm-css-bgimage-control" class="rm-css-bgimage-control" style="z-index:1000">
            <form class="rm-widget disabled" id="bgimage-upload" method="post" action="#">
              ...
              <div style="position:absolute; top:0px; z-index:1000000" >
                <script type="text/javascript">
AC_FL_RunContent( 'style','visibility: visible;','id','rm-css-bgimage-uploaderUploader','data','/uploadify.swf','type','application/x-shockwave-flash','width','0','height','18','quality','high','wmode','transparent','allowscriptaccess','always','flashvars','uploadifyID=rm-css-bgimage-uploader&buttonText=Upload%20new&script=/upload.ashx&folder=<%=strFBUserId%>-tabs&width=0&height=120&wmode=transparent&method=POST&queueSizeLimit=200999&simUploadLimit=1&hideButton=true&fileDesc=jpg, jpeg, png, gif&fileExt=*.jpg;*.jpeg;*.gif;*.png&auto=true&sizeLimit=10000000&fileDataName=Filedata&' ); //end AC code
</script><noscript><object style="visibility: visible;" id="rm-css-bgimage-uploaderUploader" data="/uploadify.swf" type="application/x-shockwave-flash" width="0" height="18">
