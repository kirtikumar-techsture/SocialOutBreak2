                        ...
                        <td>&nbsp;</td>
                          ...
                          <tr>
                            <td height="40" align="right" valign="bottom">
                              <asp:PlaceHolder ID="pnlAutoPostOff" runat="server" Visible="false"><a href="javascript:;" class="bluetablink" runat="server" id="lnkAutoPostOff">Turn Autopost <img src='<%=ResolveUrl("Content/images/Off_bullate.png") %>' width="10" height="10" hspace="3" border="0" />Off </a></asp:PlaceHolder> 
                              <asp:PlaceHolder ID="pnlAutoPostOn" runat="server"><a href="javascript:;" class="bluetablink" runat="server" id="lnkAutoPostOnOff" >Turn Autopost <img src='<%=ResolveUrl("Content/images/On_bullate.png") %>' width="10" height="10" hspace="3" border="0" />On </a></asp:PlaceHolder>
                               &nbsp;
                              <%--<a href="javascript:;" class="bluetablink" runat="server" id="lnkAutoPostOnOff">Turn Autopost
                                                    ...
                                                    <tr>
                                                      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                          <tr>
                                                            ...
                                                            <td align="left" valign="top" style="padding-left:12px; color:#676767; line-height:17px; text-align:left; word-break: break-all;"><span id='spnAutoPost<%#Eval("apm_id")%>'><%#DataBinder.Eval(Container.DataItem, "apm_Message")%></span>
                                                            <br/><%#DataBinder.Eval(Container.DataItem, "apm_Link")%></td>
                                                          </tr>
                                                        </table></td>
                                                    </tr>
                                                    <tr>
                                                      ...
                                                      <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                          <tr>
                                                            ...
                                                            <td  align="right" valign="top" style="padding-top:3px; padding-right:5px;" ><table cellpadding="0" cellspacing="0" align="right" border="0">
                                                              ...
                                                              <input type="hidden" id="hdnAutoPostVideo<%#Eval("apm_id")%>" value='<%#Eval("apm_Link")%>' />
                                          ...
                                          <tr>
                                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  ...
                                                  <%#DataBinder.Eval(Container.DataItem, "apm_Link")%></td>
                                                </tr>
                                              </table></td>
                                          </tr>
                                          <tr>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <%--<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleDate")%> , <%#DataBinder.Eval(Container.DataItem, "sm_ScheduleHour")%>:<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleMinute")%>&nbsp;<%#DataBinder.Eval(Container.DataItem, "sm_ScheduleAMPM")%>--%>
                                                      ...
                                                      <td align="right" valign="top"><a href='../scheduler/<%# Container.DataItem("sm_Id")%>' style="text-decoration:none" title="Edit"><img src="../Content/images/icon_edit.gif"  hspace="7" border="0" /></a><asp:ImageButton ImageUrl="Content/images/icon_delet.gif" OnClick="DeleteByID" CommandName='<%#DataBinder.Eval(Container.DataItem, "sm_Id")%>' OnClientClick="return confirm('Are you sure want to delete this Drafts?');"  ID="btndelete" runat="server" ToolTip="Delete" />
                                              </asp:ImageButton>
                                                      </td>
                                                    </tr>
                                                  </table></td>
