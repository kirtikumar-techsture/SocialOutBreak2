...
Imports System.IO
Public Class Boresha_Sweepstake
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        FBAPPID = System.Configuration.ConfigurationManager.AppSettings("BoreshaSweepStakeFBAPI").ToString
        Dim fbappname As String = System.Configuration.ConfigurationManager.AppSettings("BoreshaSweepStakeFBAPI").ToString
