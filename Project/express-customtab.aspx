...
<script type="text/javascript">
    function ShowHideDiv(Id) {
        ...
        window.location.href="selection.aspx?ctId=" + ctId + "&userId=" + userId + "&FbuserId=" + FbuserId + "&CId=" + CompanyId + "&IId=" + IndustryId;
		//document.getElementById("Iframe1").src = "selection.aspx?ctId=" + ctId + "&userId=" + userId + "&FbuserId=" + FbuserId + "&CId=" + CompanyId + "&IId=" + IndustryId;
