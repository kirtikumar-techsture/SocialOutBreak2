...
Public Class custom_tabs_leads
    Inherits System.Web.UI.Page
    Dim objLeads As New BusinessAccessLayer.BusinessLayer.Leads
    Dim objPaging As Paging = Nothing
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ltrMsg.Text = ""
        objPaging = New Paging("bp_", ViewState, phPagingTop, phPagingBottom, _
        ...
        objPaging.PageLinkClass = "paginglink"
        If Not Page.IsPostBack Then
            If GetPageId() <> "" Then
                drpFanPages.SelectedValue = GetPageId()
            End If
            objPaging.CurrentPage = 1
    ...
    Function GetPageId() As String
        Return IIf(Request("lid") <> Nothing AndAlso Request("lid") <> "", Request("lid"), "")
    End Function
...
#End Region
    ...
    Sub BindLeads()
        ...
        objLeads.PageIndex = objPaging.CurrentPage
        objLeads.FBUserId = drpFanPages.SelectedValue
        'objLeads.FBUserId = IIf(Session("FacebookUserId") <> Nothing, Session("FacebookUserId"), "")
        objLeads.SortBy = hdnSortexp.Value
        Dim ds As DataSet = objLeads.GetAllLeadsForCT
    ...
    Private Sub dgrLeads_Sorting(sender As Object, e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles dgrLeads.Sorting
        If e.SortExpression = "Name" Then
            ...
            dgrLeads.Columns(4).HeaderText = "Status <img src='content/images/i-sort.gif' id='imgsort' border='0' align='absmiddle'/>"			
            dgrLeads.Columns(5).HeaderText = "Lead From <img src='content/images/i-sort.gif' id='imgsort' border='0' align='absmiddle'/>"
            dgrLeads.Columns(6).HeaderText = "Date <img src='content/images/i-sort.gif' id='imgsort' border='0' align='absmiddle'/>"
            BindLeads()
        End If
        ...
        If e.SortExpression = "Phone" Then
            ...
            BindLeads()
        End If
		If e.SortExpression = "Status" Then
            If dgrLeads.Columns(4).HeaderText = "Status <img src='content/images/asc.gif' id='imgsort' border='0' align='absmiddle'/>" Then
                hdnSortexp.Value = "Status DESC"
                dgrLeads.Columns(4).HeaderText = "Status <img src='content/images/desc.gif' id='imgsort' border='0' align='absmiddle'/>"
            Else
                hdnSortexp.Value = "Status ASC"
                dgrLeads.Columns(4).HeaderText = "Status <img src='content/images/asc.gif' id='imgsort' border='0' align='absmiddle'/>"
            End If
            dgrLeads.Columns(0).HeaderText = "Name <img src=content/images/i-sort.gif id=imgsort border=0 align='absmiddle'/>"
            dgrLeads.Columns(1).HeaderText = "Email <img src='content/images/i-sort.gif' id='imgsort' border='0' align='absmiddle'/>"
            dgrLeads.Columns(2).HeaderText = "Phone <img src='content/images/i-sort.gif' id='imgsort' border='0' align='absmiddle'/>"
            dgrLeads.Columns(5).HeaderText = "LeadFrom <img src='content/images/i-sort.gif' id='imgsort' border='0' align='absmiddle'/>"			
            dgrLeads.Columns(6).HeaderText = "Date <img src='content/images/i-sort.gif' id='imgsort' border='0' align='absmiddle'/>"
            BindLeads()
        End If
        If e.SortExpression = "LeadFrom" Then
            If dgrLeads.Columns(5).HeaderText = "LeadFrom <img src='content/images/asc.gif' id='imgsort' border='0' align='absmiddle'/>" Then
                hdnSortexp.Value = "LeadFrom DESC"
                dgrLeads.Columns(5).HeaderText = "LeadFrom <img src='content/images/desc.gif' id='imgsort' border='0' align='absmiddle'/>"
            Else
                hdnSortexp.Value = "LeadFrom ASC"
                dgrLeads.Columns(5).HeaderText = "LeadFrom <img src='content/images/asc.gif' id='imgsort' border='0' align='absmiddle'/>"
            End If
            dgrLeads.Columns(0).HeaderText = "Name <img src=content/images/i-sort.gif id=imgsort border=0 align='absmiddle'/>"
            dgrLeads.Columns(1).HeaderText = "Email <img src='content/images/i-sort.gif' id='imgsort' border='0' align='absmiddle'/>"
            dgrLeads.Columns(2).HeaderText = "Phone <img src='content/images/i-sort.gif' id='imgsort' border='0' align='absmiddle'/>"
        ...
        If e.SortExpression = "Date" Then
            If dgrLeads.Columns(6).HeaderText = "Date <img src='content/images/asc.gif' id='imgsort' border='0' align='absmiddle'/>" Then
                hdnSortexp.Value = "Date DESC"
                dgrLeads.Columns(6).HeaderText = "Date <img src='content/images/desc.gif' id='imgsort' border='0' align='absmiddle'/>"
            Else
                hdnSortexp.Value = "Date ASC"
                dgrLeads.Columns(6).HeaderText = "Date <img src='content/images/asc.gif' id='imgsort' border='0' align='absmiddle'/>"
            End If
            dgrLeads.Columns(0).HeaderText = "Name <img src=content/images/i-sort.gif id=imgsort border=0 align='absmiddle'/>"
            dgrLeads.Columns(1).HeaderText = "Email <img src='content/images/i-sort.gif' id='imgsort' border='0' align='absmiddle'/>"
            dgrLeads.Columns(2).HeaderText = "Phone <img src='content/images/i-sort.gif' id='imgsort' border='0' align='absmiddle'/>"
