        ...
        <td style="border:1px solid #bdc7d8; background-color:#FFF; padding-left:20px; padding-right:20px;">                <div id="editor-nav">
                  <div class="editor-nav-panel rc-m">
                    <div class="editor-nav-panel-content">
                      ...
                      <div id="helptext1" style="background-image:url(content/images/facebook_frame_coaching2_video_bg.png); background-position:top; background-repeat:no-repeat; width:660px; height:474px; text-align:left;position:absolute;top:-200px;left:-360px;display:none;z-index:90000">
                      ...
                      <a id="ch_temp"  href="javascript:;" target="_parent" class="nav-action-button rc-m " title="Change Template for this Page." onclick="chkTemplatePage3('Warning! Please Save your work befor leave this page othrewise your changes will be descarded');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Change Template</a><a id="lnkResize"  href="javascript:;" target="_parent" class="nav-action-button rc-m " style="width:190px;" title="Crop Image" onclick="PopupCenter('crop2.aspx', 'Resize','800','700');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Crop Image</a>
...
<div style="display:none; opacity: 1; left: 758px; top: 244px; height: 258px;clear:both; width:420px; padding-left:30px;" id="rm-appearance-panel" class="">
