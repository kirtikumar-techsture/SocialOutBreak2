<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="contact-us-tab.aspx.vb" Inherits="tsma.contact_us_tab" %>
...
<script type="text/javascript">
    ...
    function submitcontact() {
        ...
        if (fields != "") {
            ...
            $.ajax({ url: '/ajax/ajax-custom-tab-info.aspx?nm=' + $("#name").val() + '&appid=' +  $("#hdnAppId").val()  + '&appname=' + $("#hdnAppName").val() + '&msg=' + $("#msg").val()  + '&em=' + $("#email").val() + '&ph=' + $("#phno").val() + '&fbuid=' + $("#hdnFBUserId").val() + '&tsmauid=' + $("#hdnTSMAUserId").val() + '&fbpid=' + $("#hdnFBPageId").val() + '&fbpagename=' + $("#hdnFBPageName").val(), success: function (result) {
...
<script type="text/javascript">
    function share(message) {
       ...
       /*  FB.ui(
        ...
        name: 'Summa Social',
        link: 'https://www.summasocialapp.com/',
        picture: 'http://www.summasocialapp.com/Content/images/we_build_img.jpg',
