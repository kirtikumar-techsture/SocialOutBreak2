...
<head runat="server">
    ...
    function toMem(a) {
        newCookie('UserName1', document.getElementById('txtUid').value);     // add a new cookie as shown at left for every
        newCookie('Password1', document.getElementById('txtPwd').value);   // field you wish to have the script remember
    }
    
    function delMem(a) {
      eraseCookie('UserName1');   // make sure to add the eraseCookie function for every field
      eraseCookie('Password1');
    
        document.getElementById('txtUid').value = '';   // add a line for every field
...
<body>
   <form id="frm1" runat="server"  name="frm1" onSubmit="if(this.checker.checked) toMem(this)">
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <div id="divBackGround1" style="padding-top:110px; padding-bottom:70px; z-index:1" align="center">
<div style="background-image:url(Content/images/site_user_login_bg.png); background-position:top; background-repeat:no-repeat; width:392px; height:257px; z-index:1000000 ">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="161" height="30" align="right" valign="middle"><font color="#FFFFFF">User Name:
    </font>&nbsp;</td>
  ...
  <tr>
    <td align="right" valign="middle"><font color="#FFFFFF">Remember Me?:</font>&nbsp;</td>
...
<table>
  ...
  <tr>
   ...
   <script type="text/javascript" language="javascript">
		<!--
		document.getElementById('txtUid').value = readCookie("UserName1");  // Change the names of the fields at right to match the ones in your form.
		document.getElementById('txtPwd').value = readCookie("Password1");
		//-->
		</script>
    </form>
</body>
