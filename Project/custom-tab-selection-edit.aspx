  ...
  <div id="innerpagepagemain"  >
	...
	line-height:18px; text-align:center">&nbsp;<br />
        ...
        html,body{padding:0px;margin:0px;background-color: transparent;}.SafariBgFix{background-repeat:no-repeat;}
                            ...
                            <td style="border:1px solid #bdc7d8; background-color:#FFF; padding-left:20px; padding-right:20px;"><div id="helptext1" style="background-image:url(content/images/facebook_frame_coaching2_video_bg.png); background-position:top; background-repeat:no-repeat; width:660px; height:474px; text-align:left;position:absolute;top:265px;left:170px;display:none;z-index:90000">
                              ...
                              <div id="editor-nav">
                                <div class="editor-nav-panel rc-m">
                                  <div class="editor-nav-panel-content"> <a href="#" class="nav-action-button rc-m rm-css-control-close" style="width:190px;" title="Watch Video Tutorial" onclick="$('#helptext1').fadeIn();"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Watch Video Tutorial</a> <a id="rm-content-launch"  href="#launch-content" style="width:190px;" class="nav-action-button rc-m rm-css-control-close" title="Edit text content"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Edit Text / Upload Video</a> <a id="rm-css-launch" href="#launch-css" class="nav-action-button rc-m " style="width:190px;" title="Edit Appearance of the Presentation!"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Edit Color & Images</a> <a id="ch_temp"  href="javascript:;" target="_parent" class="nav-action-button rc-m " style="width:190px;" title="Change Template for this Page." onclick="chkTemplatePage3('Warning! Please Save your work befor leave this page othrewise your changes will be descarded');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Change Template</a> <a id="lnkResize"  href="javascript:;" target="_parent" class="nav-action-button rc-m " style="width:190px;" title="Crop Image" onclick="PopupCenter('crop2.aspx', 'Resize','800','700');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Crop Image</a> <a  href="#launch-css" class="nav-action-button rc-m " style="width:190px;" title="Unhide Hidden Icons" onclick="$('.url').css('display','');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Unhide Icons</a> <a href="javascript:;" onclick="FacebookAlert();" style="width:190px;" class="nav-action-button rc-m " title="Reset selected template"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Reset</a><a href="#" id="lnkReset" runat="server" style="display:none" ></a> <a href="javascript:;"  class="nav-action-button rc-m " style="width:190px;" title="Save CustomTab" id="lnkSaveName" runat="server" onclick="return OpenDivCustomTabName();" ><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Save</a> <a href="javascript:;"  class="nav-action-button rc-m " style="width:190px;" title="Share Custom Tab" id="lnkShare" onclick="return OpenDivShareCustomTabName();" ><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Share</a> <a href="javascript:;" class="nav-action-button rc-m " style="width:190px;" title="Publish CustomTab" id="lnkPublish"  onclick="showPages();"><img id="img1" src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Publish Custom Tab</a>
                ...
                <asp:PlaceHolder ID="pnlMessage" runat="server" Visible="false">
                  <table align="right" width="270" border="1" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td align="left" valign="top" style="padding:15px; padding-top:15PX; border-bottom:1px solid #dde2eb; border-right:1px solid #dde2eb; background-color:#EDEFF4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="center" style="vertical-align:middle; line-height:18px; padding-top:10px; padding-bottom:15px;"><span id="spnAssigned" runat="server"></span></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table>
              ...
              <div class="Fanpagesdiv1" id="Fanpagesdiv11" style="display:none; width:670px; height:450px; border:0px solid #ff0000; position:absolute; z-index: 1000; ">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="right" valign="top" class="greypopupbordertop" style="padding-right:30px;"><img src="../Content/images/grey_popup_top.gif" width="31" height="11" /> </td>
                  </tr>
                  <tr>
                    <td align="left" valign="top" class="greypopupborder" style="padding:13px; padding-bottom:16px; padding-right:0px;"><table cellpadding="0" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                          <td colspan="2" valign="top"><div style=" width:650px; height:450px; overflow:auto; background-color:#ffffff;padding:0px; padding-top:0px; border:1px solid #cccccc;">
                              <asp:PlaceHolder ID="plcData1" runat="server">
                                <asp:DataList id="dstFanPages1" runat="server" RepeatColumns="4" CellPadding="0" CellSpacing="0" ItemStyle-VerticalAlign="top" RepeatDirection="Horizontal" >
                                  <itemtemplate>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td colspan="2" style="border-top:2px solid #cccccc;height:20px;"></td>
                                      </tr>
                                      <tr>
                                        <td width="150" valign="top" align="center"><img src='<%#Eval("picture")%>' height="102" width="102" class='imgborder' group="pageimg" pageid='<%#Eval("Id")%>' /></td>
                                        <td width="10" >&nbsp;</td>
                                      ...
                                      <tr height="30" align="center">
                                        <td><a href="javascript:;" onclick="PostCustomTab(this);" id="hrefPost" runat="server"> <%#Eval("name")%> </a>
                                          <%-- <input type="hidden" id="hdnPageId" runat="server" value='<%#Eval("Id")%>' />
							  <input type="hidden" id="hdnAccessToken" runat="server" value='<%#Eval("access_token")%>' />
							  <input type="hidden" id="hdnPageName" runat="server" value='<%#Eval("name")%>' />--%>
                                        </td>
                              ...
                              <asp:PlaceHolder ID="plcNoData1" runat="server" Visible="false"> <strong style="color:#990066"> You have no business pages.</strong><br />
                                <br />
                                <a href="javascript:CreatePage();">Click here</a> to create business page. </asp:PlaceHolder>
                            </div></td>
                        </tr>
