<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sweepstake-main.aspx.vb" Inherits="tsma.sweepstake_main" %>
    ...
    <div id="DivSaveSidebar" style="width:100%; height:750px;; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:10000000; text-align:center;padding-top:200px; padding-left:170px; display:none;">
			  <div id="popup_container1" style="width:450px; height:85px">
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  <font color="#FF0000">Warning!  This action will delete the Sweepstake from facebook business pages associated with it and from all its administrators' accounts</font><br/><br/>
    ...
    <td align="left" valign="top" ><table width="974" border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td align="left" valign="top"><table width="242" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="left" valign="top" class="facebookboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="50" align="center" valign="middle"><a id="btnVideo" runat="server" class="video">WATCH THE VIDEO</a></td>
              </tr>
              <tr>
        ...
        <td align="center" valign="top"><table width="242" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="49" align="center" valign="middle" class="facebookboxtitle" >Design Sweepstakes</td>
          </tr>
          <tr>
            <td align="center" valign="top" style="background-image:url(Content/images/title_down_bg.gif); background-position:top; background-repeat:repeat-x"><img src="Content/images/arrow_down_blue.png" width="58" height="20" /></td>
          </tr>
          <tr>
            <td align="left" valign="top" class="facebookboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="50" align="center" valign="top" class="arial13">Use this library to store and edit Sweepstakes you built.</td>
              </tr>
              <tr>
                <td height="50" align="center" valign="middle">
				<a href="sweepstake-list" class="bluetablink">Design Sweepstakes</a></td>
              </tr>
              <tr>
                <td height="330" align="center" valign="middle" class="facebookboxwhite"  >
                <asp:Panel id="pnlSidebar" runat="server">
                <a href="sweepstake-list">
             <%--   <a href="tabs-list.aspx?cid=<%=Convert.ToString(request("id"))%>">--%>
                <img id="imgtop" runat="server" src="" width="150" height="300" border="0" />
                </a>
                </asp:Panel>
                <asp:Label ID="lblNoSidebar1" runat="server" Visible="false" Font-Bold="true">No Sweepstakes Available</asp:Label>
                </td>
              </tr>
            </table></td>
          </tr>
        </table></td>
        <td align="right" valign="top"><table width="242" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="49" align="center" valign="middle" class="facebookboxtitle">My Saved Sweepstakes</td>
          </tr>
          <tr>
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="50" align="center" valign="middle"><a href="javascript:;"  onclick="showPages();" class="bluetablink">Choose Sweepstakes&nbsp;<img src="Content/images/youselect_arrow_down.png" width="11" height="6" border="0" align="absmiddle" id="img1" /></a></td>
              </tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                   ...
                   <asp:Literal ID="ltrName" runat="server"></asp:Literal><br /><br />
					<a href='javascript:;' onclick="RedirectCustomise();" >
                    <img src="" id="imgMyCustomTab" runat="server" width="150" height="300"/></a> 
                   ...
                   <input type="hidden" id="hdnMasterId" runat="server" value="0" />
					<asp:Label ID="lblNoSidebar" runat="server" Visible="false" Font-Bold="true">No Sweepstake Saved Yet</asp:Label>
					</td>
            ...
            <tr>
              <td align="left" valign="top" bgcolor="#FFFFFF" style="border:1px solid #1a356e; padding:9px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <a href="javascript:;" onclick="CopyAlert('Are you sure you want to copy this Sweepstake?');"><img src="Content/images/blue_copy_icon.png" width="15" height="15"  align="absmiddle" />&nbsp;&nbsp;&nbsp;<span style="vertical-align:middle;">Copy</span></a>
               ...
               <%-- <tr>
                ...
                <tr>
				  ...
				  <%--<asp:LinkButton ID="lnlDelete" OnClientClick="return confirm('Are you sure you want to delete this Sweepstake from your saved library?')" runat="server" Text="Delete" />--%>
                  ...
                  <table width="354" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td align="left" valign="top" bgcolor="#edeff4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="center" valign="top">Learn how to create your own Sweepstake <br />
                              with these simple steps.</td>
                          </tr>
                          <tr>
                            <td height="50" align="center" valign="middle">
				  ...
				  <table width="354" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td align="left" valign="top" bgcolor="#edeff4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td height="50" align="center" valign="middle">
							<a href="<%=ResolveUrl("create-custom-tab")%>" class="bluetablink">Design a Sweepstake</a>
							</td>
                          </tr>
                          <tr>
            ...
            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="left" valign="top" class="contentbody">
                   ...
                   <h4>Learn howto create your own Sweepstake with these simple steps</h4>
...
<script type="text/javascript" >
    ...
    function RedirectCustomise() {
        document.location.href = 'selected-sweepstake.aspx?swId=' + $('#hdnMasterId').val();
    }
