<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="siteuserlogin1.aspx.vb" Inherits="tsma.siteuserlogin1" %>
...
<body>
    <form id="form1" runat="server"  name="form1" onSubmit="if(this.checker.checked) toMem(this)">
