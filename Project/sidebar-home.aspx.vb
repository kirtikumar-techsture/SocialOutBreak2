    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Session("FacebookAccessToken") <> Nothing AndAlso Session("FacebookAccessToken") <> "" Then
                ...
                objBALimage.CompanyId = GetSetCookies.GetCookie("CompanyId") '0
                objBALimage.IndustryId = GetSetCookies.GetCookie("IndustryId") ' 1 
    ...
    Private Sub bind_mySidebars(ByVal direction As Integer)
        If Session("FacebookAccessToken") <> Nothing AndAlso Session("FacebookAccessToken") <> "" Then
            If Not Session("SiteUserId") Is Nothing Then
                ...
                obj.CompanyId = GetSetCookies.GetCookie("CompanyId") '0
                obj.IndustryId = GetSetCookies.GetCookie("IndustryId") ' 1 
                'Response.Write(Session("SiteUserId") & "FBUSErId: " & Session("FacebookUserId") & "PageID:" & Session("strPageId") & "sidebarId : " & hdnSidebar.Value & "Direction" & direction & "<br/> IndustryId: " & GetSetCookies.GetCookie("IndustryId"))
