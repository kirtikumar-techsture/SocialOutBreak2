<%@ Page Language="vb" AutoEventWireup="false" ValidateRequest="false" EnableEventValidation="false" CodeBehind="selected-sweepstake.aspx.vb" Inherits="tsma.selected_sweepstake" %>
...
<script type="text/javascript">
    ...
    */
    ...
    function HideSaveAlert() {
		//SaveLikeUnlike($('#hdnSaveMenu').val());
...
//		$('#hdnLike').val(document.getElementById("divLikeHtml").innerHTML);	
          ...
          <div id="DivShareCoverPhoto" style="width:100%; height:100%; text-align:center;  background-image:url(Content/facebookalert/images/popup_bg.png);  position:absolute; z-index:999999999; text-align:center;  display:none;">
            <div id="popup_container1" style="width:450px; height:80px;"  >
              <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left"> Sweepstakes Shared Successfully<br/>
                <br/>
                <input type="button" class="inputbutton" value="Close" id="lnkRedirectShare" onclick='$("#DivShareCoverPhoto").hide("slow");' style="cursor:pointer" runat="server" />
              </div>
            </div>
          </div>
	...
	line-height:18px; text-align:center">&nbsp;<br />
         ...
         <asp:PlaceHolder ID="pnlEdit" runat="server">
			<table align="right" width="655" border="1" cellspacing="0" cellpadding="0">
                        ...
                        <div id="helptext1" style="background-image:url(content/images/facebook_frame_coaching2_video_bg.png); background-position:top; background-repeat:no-repeat; width:660px; height:474px; text-align:left;position:absolute;top:265px; left:270px; display:none;z-index:90000">
                          ...
                          <div id="editor-nav">
                            <div class="editor-nav-panel rc-m">
                              ...
                              <a href="javascript:;"  class="nav-action-button rc-m " style="width:180px;" title="Save CustomTab" id="lnkSaveName" onclick="return OpenDivCustomTabName();" ><img src="Content/images/save_icon_sidebar.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Save</a> <a href="javascript:;"  class="nav-action-button rc-m " style="width:180px;" title="Share Custom Tab" id="lnkShare" onclick="return OpenDivShareCustomTabName();" ><img src="Content/images/share_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Share</a>
                              <a href="javascript:;" class="nav-action-button rc-m " style="width:180px; display:none" title="Publish CustomTab" id="A1"  onclick="showCustomiseUserMessage();"><img id="img2" src="Content/images/publish_custom_tab_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;" />Customize User Messages</a> <a href="javascript:;" class="nav-action-button rc-m " style="width:180px;" title="Publish CustomTab" id="lnkPublish"  onclick="showPages();"><img src="Content/images/publish_custom_tab_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Publish Sweepstakes</a>
                ...
                <tr>
                  <td height="20" align="center" valign="top"><img src="Content/images/sidebar_arrow_down.png" id="img1"  width="23" height="12" /></td>
                </tr>
                <tr>
                <td>
...
<div style="float:left; background-color:#f3f3f3; border-top:#dedee1 2px solid; border-bottom:#dedee1 2px solid; width:700px;
...
<input type="hidden" id="hdnSaveMenu" value="2" runat="Server" />
                            ...
                            <td height="25" align="left" valign="middle" ><asp:TextBox ID="txtShareMessage" runat="server" CssClass="sweepstakeinputarea"></asp:TextBox></td>
                              ...
                              <tr>
                                ...
                                <asp:Label id="lblErShareImage" runat="server"></asp:Label>
                                 <a id="lnkShareImage" runat="Server" target="_blank"><asp:Label id="lblShareImage" runat="server"></asp:Label></a> </font>                                
                                </td>
                              </tr>
                          <%--   <tr>
...
<script type="text/javascript" >
    ...
    function showCustomiseUserMessage() {
        ...
        pos = findPos(document.getElementById('img1'));
        var lft = pos[0] - 250;
        document.getElementById('CustomiseUserMessages').style.left = lft + 'px';
        lft = pos[1] + 50;
