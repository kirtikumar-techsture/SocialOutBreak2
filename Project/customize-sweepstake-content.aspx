<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="customize-sweepstake-content.aspx.vb" Inherits="tsma.customize_sweepstake_content" %>
...
<script>
    ...
    (function (d, s, id) {
        ...
        js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=443004229093963";
...
<script>
    ...
    window.fbAsyncInit = function () {
        FB.init({
			...
			//appId: '340481519402098',//$('#FBApplicationId').val(), //so.tsma customize sweepstakes
			appId: '117139805135174', //summa customize sweepstakes
            //appId: '443004229093963', //uswebsocial.com 
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        //var ShareImageName = "http://192.168.19.28:5069/Content/uploads/images/" + $("#hdnShareImage").val();
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.6.1/jquery.min.js" type="text/javascript"></script>
  ...
  <input type="hidden" id="hdnFBPageName" runat="server" name="hdnFBPageName"  />
   ...
   <input type="hidden" id="hdnlikeunlike" runat="server" name="hdnlike"  />
