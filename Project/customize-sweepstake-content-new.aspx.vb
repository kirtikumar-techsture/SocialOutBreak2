...
Public Class customize_sweepstake_content_new
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            objCustomTab.FBApplicationId = ConfigurationManager.AppSettings("CustomizeSweepStakeFBAPI810").ToString()
            FBApplicationId.Value = ConfigurationManager.AppSettings("CustomizeSweepStakeFBAPI810").ToString()
            ...
            'divUnliked.InnerHtml = objCustomTab.UnlikeContent.Replace("<br/>", "").Replace("notextedit", "").Replace("setLocation", "")
            ...
            FBAPPID = System.Configuration.ConfigurationManager.AppSettings("CustomizeSweepStakeFBAPI810").ToString
