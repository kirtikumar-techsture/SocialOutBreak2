...
Public Class lexus_sweepstake
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        FBAPPID = System.Configuration.ConfigurationManager.AppSettings("LexusSweepStakeFBAPI").ToString
        Dim fbappname As String = System.Configuration.ConfigurationManager.AppSettings("LexusSweepStakeFBAPIName").ToString
