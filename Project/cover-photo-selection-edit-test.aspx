<%@ Page Language="vb" AutoEventWireup="false" Debug="true" validateRequest="false" CodeBehind="cover-photo-selection-edit-test.aspx.vb" Inherits="tsma.cover_photo_selection_edit_test" %>
...
<table width="599" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><img border="0" src="Content/images/arrow_big_up.png" width="99" height="33" /></td>
  </tr>
  <tr>
    <td align="left" valign="top" style="padding:27px; padding-top:15PX; border-bottom:1px solid #dde2eb; border-right:1px solid #dde2eb; background-color:#f3f4f8"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><table border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="90" align="left" valign="middle"><img border="0" src="Content/images/quick_start_tutorial_icon.png" width="85" height="61" align="absmiddle" /></td>
      ...
      <tr>
        <td align="center" valign="bottom"><img border="0" src="Content/images/edit_mode_top.png" width="36" height="7" /></td>
        </tr>
      <tr>
        ...
        <td style="border:1px solid #bdc7d8; background-color:#FFF; padding-left:20px;">                <div id="editor-nav">
          <div class="editor-nav-panel rc-m">
            <div class="editor-nav-panel-content">
              <a  href="#" class="nav-action-button rc-m rm-css-control-close" title="Watch Video Tutorial" onclick="$('#helptext1').fadeIn();"><img border="0" src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Watch Video Tutorial</a> 
              ...
              <a id="rm-content-launch"  href="#launch-content" class="nav-action-button rc-m rm-css-control-close" title="Edit text content"><img border="0" src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Edit Text</a> 
              <a id="rm-css-launch" href="#launch-css" class="nav-action-button rc-m " title="Edit Appearance of the Presentation!"><img border="0" src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Edit Color & Images</a> 
              <a id="ch_temp"  href="javascript:;" target="_parent" class="nav-action-button rc-m " title="Change Template for this Page." onclick="chkTemplatePage3('Warning! Please Save your work befor leave this page othrewise your changes will be discarded');"><img border="0" src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Change Template</a><a id="lnkResize"  href="javascript:;" target="_parent" class="nav-action-button rc-m " title="Crop Image" onclick="PopupCenter('crop2.aspx', 'Resize','800','700');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Crop Image</a>
              <a id="lnkShare"  href="javascript:;" target="_parent" class="nav-action-button rc-m " title="Share With User" onclick="$('#DivCoverPhotoUserEmail').show('slow');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Share With User</a>
              <a href="javascript:;" onclick="FacebookAlert();" class="nav-action-button rc-m " title="Reset selected template"><img border="0" src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Reset</a>
              <a href="#" id="lnkReset" runat="server" style="display:none" ></a>
              <a href="#"  class="nav-action-button rc-m " title="Save CoverPhoto" id="lnkSaveName" runat="server" onclick="SaveCoverPhoto();GetWidthHeight();" ><img border="0" src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Save</a><a href="#" id="lnkSave" runat="server" style="display:none"></a>
              <a href="#"  class="nav-action-button rc-m " title="Publish CoverPhoto" id="lnkPublish" runat="server" onclick="PublishCoverPhoto();GetWidthHeight();"><img border="0" src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Publish Cover Photo</a>
              <a href="#"  class="nav-action-button rc-m " title="Download" onclick="DownloadAlert();DownloadCoverPhoto();GetWidthHeight();" style="display:none"><img border="0" src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Download</a>
              <a href="#"  id="lnkDownload" runat="server" style="display:none" ></a>
              <div style="padding-left:200px; padding-top:200px;"><img border="0" id="imgLoading" src="content/images/bigspinner.gif" style="display:none" /> </div>
