    ...
    var CarouselEvo = function (element, options) {
            ...
            var slideClick = function (event) {
					...
					else
					{
						...
						var CompanyId3 = document.getElementById("hdnCompanyId").value;
						var IndustryId3 = document.getElementById("hdnIndustryId").value;
						document.getElementById("lnkCoverPhoto2"  + $this.attr("id")).href= "cover-photo-selection.aspx?cpId=" + $this.attr("id") + "&userId=" + userId3 + "&FbuserId=" + FbuserId3 + "&CId=" + CompanyId3 + "&IId=" + IndustryId3;	
						//document.getElementById("Iframe1").src = "cover-photo-selection.aspx?cpId=" + $this.attr("id") + "&userId=" + userId + "&FbuserId=" + FbuserId + "&CId=" + CompanyId + "&IId=" + IndustryId;
					}
