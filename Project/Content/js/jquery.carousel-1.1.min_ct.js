            ...
            var slideClick = function (event) {
					...
					else
					{
						$(".carousel").hide("slow");
						 $("#customtab").hide();
						$(".carousel1").show("slow");
						var userId2 = document.getElementById("hdnUserId").value;
						var FbuserId2 = document.getElementById("hdnFBUserId").value;
						var CompanyId2 = document.getElementById("hdnCompanyId").value;
						var IndustryId2 = document.getElementById("hdnIndustryId").value;
						//var id1= "lnkCustomTab2" + $this.attr("id");
						document.getElementById("lnkCustomTab2" + $this.attr("id")).href = "custom-tab-selection.aspx?ctId=" + $this.attr("id") + "&userId=" + userId2 + "&FbuserId=" + FbuserId2 + "&CId=" + CompanyId2 + "&IId=" + IndustryId2;
						//document.getElementById("Iframe1").src = "custom-tab-selection.aspx?ctId=" + $this.attr("id") + "&userId=" + userId + "&FbuserId=" + FbuserId + "&CId=" + CompanyId + "&IId=" + IndustryId;
