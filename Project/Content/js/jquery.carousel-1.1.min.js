    ...
    var CarouselEvo = function (element, options) {
            ...
            var slideClick = function (event) {
					...
					else
					{
						...
						document.getElementById("lnkSidebar2" + $this.attr("id")).href = "sidebar_selection.aspx?sdId=" + $this.attr("id") + "&userId=" + userId2 + "&FbuserId=" + FbuserId2 + "&CId=" + CompanyId2 + "&IId=" + IndustryId2;	
						//document.getElementById("Iframe1").src = "sidebar_selection.aspx?sdId=" + $this.attr("id") + "&userId=" + userId + "&FbuserId=" + FbuserId + "&CId=" + CompanyId + "&IId=" + IndustryId;
