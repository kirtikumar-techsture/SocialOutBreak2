<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Boresha_Sweepstake.aspx.vb" Inherits="tsma.Boresha_Sweepstake" %>
...
<script>
    ...
    window.fbAsyncInit = function () {
        FB.init({
			...
			appId: '155244437962178', //Boresha Sweepstake
            ...
            FB.ui(
                    {
                        ...
                        picture: 'http://so.tsmaapplication.com/Content/images/Boresha_Sweepstakes/boresha_logo.png',
                        caption: '',
                        description: 'What`s better than a free new ipad2? i entered and thought you would like to also. Take a look... NO PURCHASE NECESSARY.',
                        message: ''
                        //actions: [
...
<div id="divUnLiked" runat="server" Visible="" style="padding-left:80px;">
<table width="810" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="137" align="left" valign="top" bgcolor="#FFFFFF">
	<img src="Content/images/Boresha_Sweepstakes/boresha_before_like.png" border="0" width="636" height="681"/>
    </td>
  </tr>
</table>
</div>
...
<table width="810" height="700" border="0" align="center" cellpadding="0" cellspacing="0" style="padding-left:80px;">
  <tr>
    <td align="left" valign="top" style="background:url(Content/images/Boresha_Sweepstakes/boresha_after_like.png) no-repeat; width:">
    	<table align="left" border="0" cellpadding="0" cellspacing="0" style="margin-top:345px; margin-left:223px;">
        <tr>
        	<td >
            <a href="javascript:;" onclick="ShowForm();">
            <img src="../Content/images/amerifirst-sweepstake-images/facebook_transparent_img.png" 
            width="190" height="63" border="0" align="top" /></a>
            </td>
        </tr>
        </table>
    </td>
