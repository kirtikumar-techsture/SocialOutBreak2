...
Public Class ajax_customise_sweepstak_contest
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strMess = Request("msgtext")
        If strMess = "" Then
            strMess = "Thank you for entering our sweepstakes on our Facebook Business page!  Our sweepstakes platform draws a winner the 15th of every month.  If you did not win, we automatically put you back in the sweepstakes for the next month.  We hope you win! <br><br>Please visit our community frequently and let us know how you are enjoying our product and/or service.<br><br><br>All the best.<br>"
        End If
        ...
        Else
            SendExternalEmail("postmaster@no-reply.com", Request("em"), "Sweepstakes Entry", Request("msgtext"), "", "")
        End If
...
#Region "Send External Email"
    Sub SendExternalEmail(ByVal strFrom As String, ByVal strTo As String, ByVal strSubject As String, ByVal strMailBody As String, ByVal strcc As String, ByVal strbcc As String)
        ...
        Else
            mailMessage.Body = "Thank you for entering our sweepstakes on our Facebook Business page!  Our sweepstakes platform draws a winner the 15th of every month.  If you did not win, we automatically put you back in the sweepstakes for the next month.  We hope you win! <br><br>Please visit our community frequently and let us know how you are enjoying our product and/or service.<br><br><br>All the best.<br>"
        End If
