...
Public Class referrer
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim objReferrerInfo As New clsReferrer
        objReferrerInfo.ReferrerUrl = MyUrl.AbsoluteUri
        ds = objReferrerInfo.GetReferrerData
        If ds.Tables(0).Rows.Count > 0 Then
            hdnReferrerUrl.Value = ds.Tables(0).Rows(0).Item("r_ReferrerUrl")
            hdnFBReferrerUrl.Value = ds.Tables(0).Rows(0).Item("r_ReferrerFBTabs")
        End If
        ...
        'If b.IsMatch(u) Or v.IsMatch(Left(u, 4)) Then Response.Redirect(hdnFBReferrerUrl.Value)

        Response.Redirect(hdnFBReferrerUrl.Value)

        'Response.Write("Referrer URL  : " & hdnFBReferrerUrl.Value & "<br>")
        'Response.Write("Referrer URL  : " & MyUrl.AbsoluteUri & "<br>")
