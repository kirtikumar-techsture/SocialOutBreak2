<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="rajni-post.aspx.vb" Inherits="tsma.rajni_post" %>
...
<script type="text/javascript" language="javascript">
    ...
    function OpenAutoPostBusinessPageDiv() {
        ...
        var x = pos.left;
        var y = pos.top;
        $('#divAutoPostFanPages').css('left', x - 15 + 'px')
    ...
    function RemoveFileUploadImage() {
        ...
        document.getElementById('imgPhoto').src = "../content/uploads/images/no_img.jpg";
    ...
    function EditLib(Id) {
        ...
        //$("#imgPhoto").attr('src', 'http://www.tsmaapplication.com/content/uploads/images/' + $('#hdnImage1').val());
        //$("#imgPhoto").attr('src', 'http://www.techsturedevelopment.com/content/uploads/images/' + $('#hdnImage1').val());
        $("#imgPhoto").attr('src', '../content/uploads/images/' + $('#hdnImage1').val());
        $('#hdnImageChange').val($("#imgPhoto").attr('src'));
        $('#txtvideo').val($.trim($('#hdnlibVideo' + Id).val()))
    ...
    function EditAutoPost(Id) {
        ...
        //$("#imgPhoto").attr('src', 'http://www.techsturedevelopment.com/content/uploads/images/' + $('#hdnImage1').val());
        $('#hdnImageChange').val($("#imgPhoto").attr('src'));
        $('#txtvideo').val($.trim($('#hdnAutoPostVideo' + Id).val()))
    ...
    <div id="centermain">
      ...
      <div id="DivShowAutoPostOnOff" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  padding-left:150px; display:none;">
        <div id="popup_AutoPostContainer" >
          <div id="popup_AutoPostContent" style="padding-top:10px; padding-left:20px; text-align:left; line-height:17px;"> <span id="spnShuffleMess"></span><br/>
            <br/>
            <input type="button" class="inputbutton" onclick="HideAutoPostOnOff();" value="Close" id="Button1" />
          </div>
        </div>
      </div>
        ...
        <tr>
          ...
          <td align="left" valign="top" class="contentbody" style="padding-left:10px; padding-right:10px;"><div style="padding-bottom:10px;">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td colspan="2" valign="middle"><div style="float:left;">
				<span class="compose_msg" id="StatusMessage"> 
				<img src="../Content/images/compose_message.gif" width="16" height="15" align="absmiddle" />&nbsp;<strong> 
				<a href="javascript:;" class="graylink" onclick="CheckMessage();">Compose Message</a></strong></span> &nbsp;&nbsp;&nbsp;<font color="#7d869d">|</font> &nbsp;&nbsp;&nbsp;<span class="photo_video"><img src="../Content/images/add_photo_video.gif" width="16" height="14" align="absmiddle" /> &nbsp;<strong><a href="javascript:;" class="graylink" onclick="CheckVideoMessage();">Add Photo &nbsp;</a> </strong></span><span class="video_div" style="display:none"><img src="../Content/images/add_photo_video.gif" width="16" height="14" align="absmiddle" /> &nbsp;<strong><a href="javascript:;" class="graylink" onclick="CheckPhotoMessage();">Add Video &nbsp;</a> </strong></span><font color="#7d869d">|</font>&nbsp;&nbsp;&nbsp;<span class="link_video"><img src="../Content/images/video_icon1.gif" align="absmiddle" />&nbsp; <strong><a href="javascript:;" class="graylink" onclick="CheckLinkMessage();">Add Link&nbsp;</a></strong></span>&nbsp;&nbsp;<font color="#7d869d">|</font>&nbsp;&nbsp;&nbsp; <span class="fans_showhide1"><img src="../Content/images/selectfanpage_icon1.gif" align="absmiddle" />&nbsp;&nbsp;<strong><a href="javascript:;" class="graylink">Select Business Pages</a></strong></span></div>
                  <div align="right" style="padding-bottom:5px;"><a href="javascript:;" class="bluetablink" onclick="ClearPost();" >Clear Post</a></div></td>
              </tr>
              <tr>
                              ...
                              <td align="left" valign="top" style="padding:7px; font-family:arial;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td align="left" style="padding-top:10px;"><strong>Select an image file on your computer.</strong><br />
                                      <input name="source" type="file" id="photo" width="200" onchange="readURL(this);" runat="server"/>
                                    ...
                                    <td align="left" valign="middle"><img width="66" height="66" id="imgPhoto" src="Content/images/no_img.jpg" runat="server"/>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td align="left" valign="top" class="popupborder" style="border-bottom:0px;"><div style="height:150px; overflow:auto; overflow-x:hidden;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="left" valign="top" style="padding:20px;"><asp:PlaceHolder ID="plcData" runat="server">
                                            ...
                                            <td width="48" align="left" valign="middle" style="background-color:#f6f6f6; " ><table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  ...
                                                  <td align="center" valign="middle"><table border="0" width="170" cellspacing="0" cellpadding="0">
                                                      <tr>
                                                        <td width="25" align="left" valign="middle" style="text-align:center; vertical-align:middle"><input class="checkboxpadding" type="checkbox" id="chkPage" name="chkPage" runat="server" pageid='<%#Eval("Id")%>' group="pages" onclick='PageidScheduler(this);selectedpagesName();'  pageaccess_token='<%#Eval("access_token")%>' pagevalue='<%#Eval("name")%>' pageimage='<%#Eval("picture")%>' /></td>
              ...
              <tr>
				...
				<table width="100%" border="1" cellspacing="0" cellpadding="0">
                    <tr>
					  ...
					  <a href="javascript:;" class="bluetablink" runat="server" onclick="return ValidateDrafts();" id="lnkSaveDraft">Save as Draft</a>&nbsp;&nbsp;
					  <a href="javascript:;" class="bluetablink" onClick="SelectLibCat();" id="lnkSaveToMyLib">Save in My Library</a>&nbsp;&nbsp;
					  <a href="javascript:;" runat="server" class="bluetablink" onclick="return ValidateQuickPost();" id="lnkPost">Quick Post</a>&nbsp;&nbsp;
					  <a href="javascript:;" class="bluetablink" onClick="SelectScheduleDiv();" id="lnkScheduleDiv">Schedule Post</a>
					  <div id="divLibCat" style="display:none; z-index:100; position:absolute; border:1px solid #eaeaea; background-color:#FFFFFF; padding:10px; width:160px;">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
              ...
              <tr>
                ...
                <td height="32" align="left" valign="bottom" ><div id="TabbedPanels1" class="TabbedPanels" >
                    <ul class="TabbedPanelsTabGroup" style="padding-left:27px;">
                      <li class="TabbedPanelsTab" tabindex="0">Auto Posts &nbsp;
                      ...
                      <li class="TabbedPanelsTab" tabindex="1"><%=tsma.GetSetCookies.GetCookie("SelectedName")%>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding-top:10px;">
                          ...
                          <tr>
                            <td align="left" valign="top" bgcolor="#f0f0f0" style="padding:15px;"><div align="center" style="text-align:center">
                              ...
                              <div style="padding-bottom:10px;"><strong>Set Date/Time</strong></div>
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="237" align="left" valign="top"><asp:DropDownList  ID="ddlAutoPostTimeZone" runat="server" style="border:1px solid #CCC; font-family:Arial; font-size:12px; color:#666; height:24px; padding:2px; width:255px;">
                                      <asp:ListItem Value="0"> Select a TimeZone </asp:ListItem>
                                      <asp:ListItem Value="Eastern Standard Time">Eastern Timezone (UTC -5.00)</asp:ListItem>
                                      <asp:ListItem Value="Central Standard Time">Central Timezone (UTC -6.00)</asp:ListItem>
                                      <asp:ListItem Value="Mountain Standard Time">Mountain Timezone (UTC -7.00)</asp:ListItem>
                                  ...
                                  <td align="right" valign="middle"><a href="javascript:;" class="bluetablink" runat="server" onclick="return ValidateAutoPost();" id="lnkAutoPost">
                                    <asp:PlaceHolder ID="pnlAutoPostSet" runat="server"> Set Auto Post </asp:PlaceHolder>
                                    <asp:PlaceHolder ID="pnlAutoPostUpdate" runat="server" Visible="false"> Update Auto Post </asp:PlaceHolder>
                                    </a> </td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr>
                            <td align="left" valign="bottom" style="padding-top:10px;"><font style="line-height:20px; font-weight:bold">
                              ...
                              <a href="javascript:;" id="AutoPostOpener" onclick="OpenAutoPostBusinessPageDiv();" runat="server" style="font-weight:bold;">Add Business Page(s):</a>
                              <div id="divAutoPostFanPages" style="display:none; z-index:100; width:745px; position:absolute; border:1px solid #CCCCCC; background-color:#f6f6f6;" title="Business Pages">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td align="left" valign="top" style="padding:20px; "><asp:PlaceHolder ID="plcAutoData" runat="server">
                                        <div style="height:125px; width:723px; overflow:auto; overflow-x:hidden;">
                                          <asp:DataList ID="dstAutoPostFanPages" runat="server" RepeatColumns="3" RepeatDirection="Horizontal">
                                            <ItemTemplate>
                                              <table width="230" style="overflow-x:scroll" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td colspan="2" height="4"></td>
                                                </tr>
                                                <tr>
                                                  <td width="48" align="left" valign="middle" style="background-color:#FFFFFF; border:1px solid #CCCCCC;" ><table border="0" cellspacing="0" cellpadding="0">
                                                      <tr>
                                      ...
                                      <asp:PlaceHolder ID="plcNoAutoData" runat="server" Visible="false"> <strong style="color:#990066"> You have no business pages.</strong><br />
                                        <br />
                                        <a href="javascript:CreatePage();">Click here</a> to create business page. </asp:PlaceHolder>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td valign="top" align="right" style="padding-right:30px; padding-bottom:10px;"><a href="javascript:;" class="bluetablink" onclick="HideAutoPostFanPages();">Save</a></td>
                                  </tr>
                                </table>
                              </div>
                          ...
                          <tr>
                            <td height="40" align="right" valign="bottom"><a href="javascript:;" class="bluetablink" runat="server" id="lnkAutoPostOnOff">Turn Autopost
                              <asp:PlaceHolder ID="pnlAutoPostOff" runat="server" Visible="false"> <img src='<%=ResolveUrl("Content/images/Off_bullate.png") %>' width="10" height="10" hspace="3" border="0" />Off </asp:PlaceHolder>
                              <asp:PlaceHolder ID="pnlAutoPostOn" runat="server"> <img src='<%=ResolveUrl("Content/images/On_bullate.png") %>' width="10" height="10" hspace="3" border="0" />On </asp:PlaceHolder>
                              </a> &nbsp;<a href="javascript:;" class="bluetablink" runat="server" onclick="return confirm('Are you sure you want to import the entire library?');" id="lnkAutoPostShuffle">Import Library</a>
                              <asp:PlaceHolder ID="pnlClearAll" runat="server" Visible="false"><a href="javascript:;" class="bluetablink" runat="server" id="lnkClearAll" onclick="return confirm('Are you sure you want to delete all the posts in Autopost?');">Clear All</a> </asp:PlaceHolder>
                            </td>
                          </tr>
                          <tr>
...
AC_AX_RunContent( 'style','height: 100px; width: 100px','src','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','type','application/x-shockwave-flash','allowfullscreen','true','allowscriptaccess','always','width','100','height','100','movie','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','wmode','transparent' ); //end AC code
                                                            ...
                                                            <td align="left" valign="top" style="padding-left:12px; color:#676767; line-height:17px; text-align:left; word-break: break-all;"><span id='spnAutoPost<%#Eval("apm_id")%>'><%#DataBinder.Eval(Container.DataItem, "apm_Message")%></span></td>
                                                          </tr>
                                                        </table></td>
                                                    </tr>
                                                    <tr>
                                                      ...
                                                      <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                          <tr>
                                                            ...
                                                            <td  align="right" valign="top" style="padding-top:3px; padding-right:5px;" ><table cellpadding="0" cellspacing="0" align="right" border="0">
                                                                <tr>
                                                                  <td align="right" valign="top"><input type="hidden" id="hdnAutoPost<%#Eval("apm_id")%>" value='<%#Eval("apm_Image")%>' />
                                                                  ...
                                                                  <td align="right" valign="top"><asp:LinkButton OnCommand="DeleteMyAutoPost" onclientclick="return Prompt('Are you sure you want to delete this AutoPost?');" CommandArgument='<%#Eval("apm_id")%>' CommandName='<%#Eval("apm_id")%>' id="lnkAutoPostDelete" runat="server" ToolTip="Remove"><img src="../Content/images/icon_delet.gif" border="0" hspace="7" alt="Remove"/></asp:LinkButton></td>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                      <ContentTemplate>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                          <tr>
                                            <td align="left" valign="top"><asp:Literal ID="ltrSentAutoPostRpt" runat="server"></asp:Literal>
...
AC_AX_RunContent( 'style','height: 100px; width: 100px','src','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','type','application/x-shockwave-flash','allowfullscreen','true','allowscriptaccess','always','width','100','height','100','movie','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','wmode','transparent' ); //end AC code
                                                            ...
                                                            <td align="left" valign="top" style="padding-left:5px;  text-align:left;  word-break: break-all;"><span id='spnAutoPost<%#Eval("apm_id")%>'> <%#DataBinder.Eval(Container.DataItem, "apm_Message")%> </span></td>
                                                          </tr>
                                                        </table></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                      <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                          <tr>
                                                            <td align="left" valign="top" class="tahoma12grey" style="display:none"><strong>Auto Post Submitted On
                      ...
                      <div class="TabbedPanelsContent">
                        ...
                        <div align="center" style="color:Red;">
                          <asp:Literal ID="ltrAdminLibMsg" runat="server"></asp:Literal>
                        </div>
                                                ...
                                                <tr id='trLibCat<%#Eval("Id")%>' style="display:<%#iif(Eval("Row")=1,"","none")%>" group='libcattr'>
                                                  <td style="padding-left:15px; padding-top:20px; border:1px solid #d3d3d3;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <asp:Repeater id="rptAdminLib" runat="server" DataSource='<%#BindAdminLibraries(Eval("Id"))%>'>
                                                        <itemtemplate>
                                                          <tr>
                                                            <td style="border-bottom:2px solid #d3d3d3; padding-bottom:22px;"><table width="100%" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                  <td align="left" valign="top" width="100" style="display:<%#iif(Eval("lib_Image")<>"" or Eval("lib_VideoId")<>"" ,"","none")%>"><asp:PlaceHolder ID="pnlAdminLibImage" runat="server" Visible='<%#Eval("lib_Image")<>""%>'>
                                                                      <div id="divAdminLibImage" style="padding-bottom:10px;"> <img id="imgUserLibPhoto" src='<%=System.Configuration.ConfigurationManager.AppSettings("AppPath")%>resize-tabs.ashx?P=/content/uploads/images/<%#Eval("lib_Image")%>&D=100x100' border="0" style=" cursor:pointer" class="grayborder" /> </div>
                                                                    </asp:PlaceHolder>
                                                                    &nbsp;
                                                                    &nbsp;&nbsp;
...
AC_AX_RunContent( 'style','height: 100px; width: 100px','src','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','type','application/x-shockwave-flash','allowfullscreen','true','allowscriptaccess','always','width','100','height','100','movie','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','wmode','transparent' ); //end AC code
                                                                  ...
                                                                  <td align="left" valign="top" style="padding-left:12px; color:#676767; text-align:justify; line-height:18px; padding-right:15px; WORD-BREAK:BREAK-ALL "><span id='spnlib<%#Eval("lib_Id")%>'> <%#Eval("lib_Template")%></span>
                                                                ...
                                                                <tr>
                                                                  <td align="right" valign="top" colspan="2"  style="padding-right:15px; padding-top:5px;"><table cellpadding="0" cellspacing="0" align="right" border="0">
                                                                      <tr>
                                                                        ...
                                                                        <td align="right" valign="middle"><asp:LinkButton OnCommand="AddLibToAutoPost" onclientclick="return PromtAddToautoPost();" CommandArgument='<%#Eval("lib_Id")%>' CommandName='<%#Eval("lib_Id")%>' id="lnkAddLibtoAutoPost" CssClass="bluetablink" runat="server">
                                                                            <asp:PlaceHolder ID="plhNotAdded" runat="server"> Add To AutoPost</asp:PlaceHolder>
                          ...
                          <ContentTemplate>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr id="trMyLib" style="display:" group="libtr">
                                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td align="center" height="30"><font color="red" style="text-align:center; font-size:14px; font-family:Arial, Helvetica, sans-serif">
                                    ...
                                    <asp:Repeater id="rptUserLibCat" runat="server">
                                      <itemtemplate>
                                        <tr >
                                          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tr style="display:none">
                                                <td onclick='ShowUserLib(<%#Eval("Id")%>);' class="tdindustry" style="cursor:pointer;"><img src="../Content/images/folder_icon2.gif" width="16" height="16"  style="padding-right:5px;"/> <strong><%#Eval("Title").replace("{%Selection%}", strSelectionType)%></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                  <asp:PlaceHolder ID="pnlLibCatDel" runat="server" Visible='<%#Eval("lc_UserId")<>-1%>'>
                                                    ...
                                                    <asp:Repeater id="rptUserLib" runat="server" DataSource='<%#BindUserLibraries(Eval("Id"))%>'>
                                                      <itemtemplate>
                                                        <tr>
                                                          <td style="border-bottom:2px solid #d3d3d3; padding-bottom:22px;"><table width="100%" cellpadding="0" cellspacing="0">
                                                              <tr>
                                                                <td align="left" valign="top" width="100" style="display:<%#iif(Eval("lib_Image")<>"" or Eval("lib_VideoId")<>"" ,"","none")%>"><asp:PlaceHolder ID="pnlUserLibImage" runat="server" Visible='<%#Eval("lib_Image")<>""%>'>
                                                                    <div id="divUserLibImage" style="padding-bottom:10px;"> <img id="imgUserLibPhoto" src='<%=System.Configuration.ConfigurationManager.AppSettings("AppPath")%>resize-tabs.ashx?P=/content/uploads/images/<%#Eval("lib_Image")%>&D=100x100' border="0" style=" cursor:pointer" class="grayborder" /> </div>
                                                                  </asp:PlaceHolder>
                                                                  &nbsp;
                                                                  &nbsp;&nbsp;
...
AC_AX_RunContent( 'style','height: 100px; width: 100px','src','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','type','application/x-shockwave-flash','allowfullscreen','true','allowscriptaccess','always','width','100','height','100','movie','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','wmode','transparent' ); //end AC code
                                                                ...
                                                                <td align="left" valign="top" style="padding-left:12px; color:#676767; line-height:18px;  text-align:left; padding-right:15px; word-break: break-all;"><span id='spnlib<%#Eval("lib_Id")%>'> <%#Eval("lib_Template")%> </span> </td>
                                                              </tr>
                                                              <tr>
                                                                <td align="right" valign="top" colspan="2" style="padding-right:15px;"><table cellpadding="0" cellspacing="0" align="right" border="0">
                                                                    <tr>
                                                                      <td align="right" valign="top"><a href="#StatusMessage" onclick='EditLib(<%#Eval("lib_Id")%>);' title="Select"><img src="../Content/images/icon_edit.gif" border="0" alt="Select"/></a>
                                                                        <input type="hidden" id="hdnlib<%#Eval("lib_Id")%>" value='<%#Eval("lib_Image")%>' />
                                                                        <input type="hidden" id="hdnlibVideo<%#Eval("lib_Id")%>" value='<%#Eval("lib_Video")%>' /></td>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      <td align="left" valign="top" width="100" style="display:<%#iif(Eval("sm_Image")<>"" or Eval("sm_VideoId")<>"" ,"","none")%>"><div id="divScheduleImage" runat="server" style="padding-top:15px;"> <img id="imgSchedulePhoto" runat="server"  border="0" class="grayborder" onMouseOver="ShowDiv('divScheduleLargeImage');" onMouseOut="HideDiv('divScheduleLargeImage');"/> </div>
  
...
AC_AX_RunContent( 'style','height:100px; width: 100px','src','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','type','application/x-shockwave-flash','allowfullscreen','true','allowscriptaccess','always','width','100','height','100','movie','<%#DataBinder.Eval(Container.DataItem, "VideoUrl")%>','wmode','transparent' ); //end AC code
                                                      ...
                                                      <td align="left" valign="top" style="padding:15px 0px; text-align:left; color:#676767; line-height:17px;"><input type="hidden" id="hdnScheduledPostId" runat="server" value='<%# DataBinder.Eval(Container.DataItem, "sm_id")%>'>
                                                        ...
                                                        <a href='<%#DataBinder.Eval(Container.DataItem, "sm_VideoLink")%>' target="_blank"><%#DataBinder.Eval(Container.DataItem, "sm_VideoLink")%></a></td>
                                                    </tr>
                                                  </table></td>
                                              </tr>
                                              <tr>
                                              ...
                                              <tr>
                                                <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      <td align="left" valign="top" style="line-height:18px;" ><strong>Scheduled for<br />
                                                        </strong>
                                                      ...
                                                      <td align="right" valign="top"><a href='../scheduler/<%# Container.DataItem("sm_Id")%>' style="text-decoration:none;" title="Edit"><img src="../Content/images/icon_edit.gif" hspace="7" border="0" /></a>
                                              ...
                                              <tr>
                                                <td align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      ...
                                                      <td align="right" valign="top"><a href='../scheduler/<%# Container.DataItem("sm_Id")%>' style="text-decoration:none" title="Edit"><img src="../Content/images/icon_edit.gif"  hspace="7" border="0" /></a>
                                                        <asp:ImageButton ImageUrl="Content/images/icon_delet.gif" OnClick="DeleteByID" CommandName='<%#DataBinder.Eval(Container.DataItem, "sm_Id")%>' OnClientClick="return confirm('Are you sure want to delete this Drafts?');"  ID="btndelete" runat="server" ToolTip="Delete" />
                                                        </asp:ImageButton>
                                                      </td>
                                                    </tr>
                                                  </table></td>
...
<script type="text/javascript" language="javascript">
    ...
    function ValidateLib() {
        ...
        if ($('#txtMessage').val() == '') {
            $('#txtMessage').addClass('error');
            alert("Please enter Compose Message!")
            return false;
        }
        else {
