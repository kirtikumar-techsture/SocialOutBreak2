                  ...
                  <table width="354" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td align="left" valign="top" bgcolor="#edeff4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="center" valign="top">Learn how to add sweepstakes <br />
                      ...
                      <tr>
                        <td align="left" valign="top" bgcolor="#edeff4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
							...
							<img id="imgSweep" runat="server" src="" width="275" height="370" />
   							<!--<img src="Content/images/LOBSweepstakes.jpg" width="275px" height="370px" />-->
							</div></td>
                          </tr>
                        </table></td>
                      </tr>
	...
	<div class="Fanpagesdiv1" id="Fanpagesdiv11" style="display:none; width:670px; height:450px; border:0px solid #ff0000; position:absolute; z-index: 1000; ">
	         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
				  ...
				  <tr bordercolor="#cccccc;" style="height:25px;">
				  <td valign="middle">
				  <b>Click on a fan page you wish to add sweepstakes</b>
				  </td>
				  <td align="right" valign="middle">
					 <a href="javascript:;" onclick="ClosePage();">[Close]</a>&nbsp;&nbsp;&nbsp;
				  </td>
                  ...
                  <asp:PlaceHolder ID="plcData1" runat="server">
				   <asp:DataList id="dstFanPages1" runat="server" RepeatColumns="4" CellPadding="0" CellSpacing="0" ItemStyle-VerticalAlign="top" RepeatDirection="Horizontal" >
					  <itemtemplate>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
							<td colspan="2" style="border-top:2px solid #cccccc;height:20px;">
							</td>
							</tr>
						  <tr>
							<td width="150" valign="top" align="center">
						  ...
						  <tr height="30" align="center">
							<td>
							<a href="javascript:;" onclick="PostSweepStake(this);" id="hrefPost" runat="server">
							<%#Eval("name")%>
							</a>
							<%--  <input type="hidden" id="hdnPageId" runat="server" value='<%#Eval("Id")%>' />
							  <input type="hidden" id="hdnAccessToken" runat="server" value='<%#Eval("access_token")%>' />
					...
					<asp:PlaceHolder ID="plcNoData1" runat="server" Visible="false">
