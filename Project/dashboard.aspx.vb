...
Public Class dashboard
    ...
    Private Sub pdfdownload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles pdfdownload.Click
        Response.AppendHeader("Content-disposition", "attachment; filename=Summa-Social-Dashboard-OverView")
        Response.ContentType = "application/pdf"
        Response.WriteFile(Server.MapPath("~") & "/Content/uploads/pdf/Summa-Social-Dashboard-OverView.pdf")
        Response.End()
    End Sub
End Class