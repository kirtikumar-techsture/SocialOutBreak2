<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sweepstake-list.aspx.vb" Inherits="tsma.sweepstake_list" %>
...
<script type="text/javascript">
    function ShowHideDiv(Id3) {
        ...
        window.parent.location="customize-sweepstake.aspx?swId=" + Id3 + "&userId=" + userId3 + "&FbuserId=" + FbuserId3 + "&CId=" + CompanyId3 + "&IId=" + IndustryId3;
    ...
    <div id="centermain">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <asp:PlaceHolder ID="plhCustomTab" runat="server">
                            <tr>
                                 ...
                                 View All&nbsp;(<asp:Literal ID="ltrCount" runat="server"></asp:Literal>)</a>&nbsp;&nbsp;<a href="javascript:;" onclick="ShowHidePaging('bypage');" class="bluetablink">View By Page</a >
                                  &nbsp;&nbsp;<a href="javascript:;" onclick="ShowHidePaging('Rotator');" class="bluetablink" id="lnkCarousal" runat="server">Carousel</a >
                                  </td>
                            </tr>
                            <tr><td>
                                            ...
                                            <td align="center" style="border:1px solid #ced5e5; padding-top:29px; padding-bottom:29px;"><asp:DataList ID="rptPaging" runat="server" RepeatColumns="1" RepeatDirection="Vertical">
                                                <ItemTemplate>
                                                  <table align="center">
                                                    <tr>
                                                       <td valign="top">
                                                        <div style="font-family: Tahoma, Geneva, sans-serifthaoma; font-size: 14px; color: #181818; font-weight:bold; text-align:center; "><%#Container.DataItem("sw_Name")%></div><br />
                                                        <a href='customize-sweepstake.aspx?swId=<%#container.dataitem("sw_id")%>'><img  alt="" src='Content/images/customtab/<%#Container.DataItem("sw_Image") %>' border="0"/></a>
    ...
    <br />
                                ...
                                <div class="slides">
                                  ...
                                  <asp:Repeater ID="rptCustomTab" runat="server">
                                    <ItemTemplate>
                                      <%--<a id="lnkSidebar" href="javascript:;" onclick='ShowHideDiv(<%#Container.DataItem("ctl_Id") %>)'><img  alt="" width="1000px" src='Content/images/<%#Container.DataItem("ctl_Image") %>' border="0"/></a>--%>
                                        <%--<a id="lnkSidebar" onclick="ShowHideDiv()" href="sidebar_selection.aspx?sdId=<%#Container.DataItem("sdm_Id") %>&userId=<%#Container.DataItem("sdm_UserId")%>&FbuserId=&CId=<%#Container.DataItem("sdm_CompanyId")%>&IId=<%#Container.DataItem("sdm_IndustryId")%>"><img  alt="" src='Content/images/<%#Container.DataItem("sdm_Image") %>' border="0"/></a>--%>
                                         <div style="cursor:pointer;" title='Click here to select this template.' id='<%#Container.DataItem("sw_Id") %>'>
                                         <div style="font-family: Tahoma, Geneva, sans-serifthaoma; font-size: 14px; color: #181818; font-weight:bold; text-align:center; "><%#Container.DataItem("sw_Name")%></div><br />
											<a href='customize-sweepstake.aspx?swId=<%#container.dataitem("sw_id")%>'><img alt="" src='Content/images/customtab/<%#Container.DataItem("sw_Image") %>' border="0"/>
                                            </a>
										 </div>
                                                  ...
                                                  <table align="center">
                                                    <tr>
                                                      <td style="padding-bottom:20px;" valign="top">
                                                       <div style="font-family: Tahoma, Geneva, sans-serifthaoma; font-size: 14px; color: #181818; font-weight:bold; text-align:center; "><%#Container.DataItem("sw_name")%></div><br />
                                                     <a href='customize-sweepstake.aspx?swId=<%#container.dataitem("sw_id")%>'><img  alt="" src='Content/images/customtab/<%#Container.DataItem("sw_Image") %>' border="0"/></a><br />
...
<script type="text/javascript">
    ...
    function ShowCustomTab(Id) {
        ...
        document.getElementById("lnkCustomTab" + Id).href = "customize-sweepstake.aspx?swId=" + Id + "&userId=" + userId + "&FbuserId=" + FbuserId + "&CId=" + CompanyId + "&IId=" + IndustryId;
    ...
    function ShowCustomTab1(Id1) {
        ...
        window.parent.location = "customize-sweepstake.aspx?swId=" + Id1 + "&userId=" + userId1 + "&FbuserId=" + FbuserId1 + "&CId=" + CompanyId1 + "&IId=" + IndustryId1;
