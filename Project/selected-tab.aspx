<%@ Page Language="vb" AutoEventWireup="false" ValidateRequest="false" CodeBehind="selected-tab.aspx.vb" Inherits="tsma.selected_tab" %>
...
<link href="<%=ResolveUrl("Content/css/sidebar_style_custom-tab.css")%>" rel="stylesheet" type="text/css" />
...
<script type="text/javascript">
			 	 ...
			 	 function SavePasteCode() {
        //alert('1111111');
        var test = document.getElementById("txtCustomCode").value;
        //alert(test);
        document.getElementById("divSidebarHtml").innerHTML = "";
        document.getElementById("divSidebarHtml").innerHTML = test;
        document.getElementById("hdnSidebarContent").value = test;
        $('#customcode').hide("slow");

        //alert(document.getElementById("hdnSidebarContent").value);
        //return false;
    }
                ...
                function ShowCustomiseTabEditMenu() {


                    $("#editor-nav").css('display', 'none');
                    $("#editor-nav1").css('display', '');
                }
                function ShowImageUploadPopup() {
                    var pos;
                    pos = findPos(document.getElementById('divMenu520'));
                    var lft = pos[0] + 130;
                    var top = pos[0] + 285;
                ...
                function showPages() {
                    ...
                    document.getElementById('Fanpagesdiv1').style.top = top + 'px';
                    $('#Fanpagesdiv1').slideDown('slow');
                }

                function showCustomisePages() {
                    var pos;
                    pos = findPos(document.getElementById('img1'));
                    var lft = pos[0] + 400;
                    var top = pos[0] + 600;
...
<script type="text/javascript">
    ...
    function ShowRequestTabUrlPopup() {
        ...
        var fburl = "";
        var summaurl = "";
        if ($("input[type='radio'].checkboxpadding").is(':checked')) {
            link = $("input[type='radio'].checkboxpadding:checked").attr('pagelink');
            pageid = $("input[type='radio'].checkboxpadding:checked").attr('pageid');
        }
        fbappid = $("#hdnApplicationID").val();
        fburl = link + "?sk=app_" + fbappid ;
        summaurl = $("#hdnPageURL").val() + pageid;
      
        $("#lblfburl").text(fburl);
        $("#lblsummaurl").text(summaurl);
        $("#lblfburl").attr('href', fburl);
        $("#lblsummaurl").attr('href', summaurl);

        var pos;
        pos = findPos(document.getElementById('img1'));
        var lft = pos[0] - 5;
        var top = pos[0] + 210;
        document.getElementById('GetPublishTabURLDiv').style.left = lft + 'px';

        document.getElementById('GetPublishTabURLDiv').style.top = top + 'px';
        $("#GetPublishTabURLDiv").show('slow');

    }

    function HideRequestTabUrlPopup() {
        $("#GetPublishTabURLDiv").hide('slow');
    }
...
<form id="frm1" runat="server">
      ...
      <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="left" valign="top" class="contentbody"><input type="hidden" id="hdnCTID" runat="server" value='' />
            <!-- Content End  here -->
            <!--new_html-->
            <input type="hidden" id="hdnApplicationID" runat="server" value="1" />
            <input type="hidden" id="hdnPubliPageID" runat="server" value="1" />
            ...
            <input type="hidden" id="hdnPageURL" runat="server" />
            <div id="DivSaveCustomTab" style="text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
            ...
            <div id="DivCustomTabName" style=" text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
              <div id="popup_container1" style="width:450px; height:80px;" >
                <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left"> Custom Tab Name:
                  ...
                  <br/>
                  <br/>
                  <a href="javascript:;" id="lnkSave" runat="server" style="display:" class="bluetablink" onclick="return ValidateSaveName();">Save</a>&nbsp;&nbsp;<a href="javascript:;" class="bluetablink" onclick='$("#DivCustomTabName").hide("slow");'>Cancel</a> </div>
              </div>
            </div>
            <div id="DivPublishCustomTab" style="text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
              <div id="popup_container1" style="width:450px; height:80px;"  >
            ...
            <div id="DivCustomTabShareEmail" style=" text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
              <div id="popup_container1" style="width:450px; height:80px;" >
            ...
            <div id="DivShareCoverPhoto" style="text-align:center;  background-image:url(Content/facebookalert/images/popup_bg.png);  position:absolute; z-index:999999999; text-align:center;  display:none;">
              <div id="Div3" style="width:450px; height:80px;"  >
                <div id="Div4" style="padding-top:10px; padding-left:20px; text-align:left"> Custom Tab Shared Successfully<br/>
                  <br/>
                  <input type="button" class="inputbutton" onclick='$("#DivShareCoverPhoto").hide("slow");' value="Close" id="lnkRedirectShare" runat="server" />
                </div>
              </div>
            </div>
	...
	line-height:18px; text-align:center">&nbsp;<br />
            ...
            <div class="content_div" style="vertical-align:top;">
              ...
              <!--<asp:UpdatePanel ID="uptMain1" runat="server">
                ...
                <tr>
                  <td align="left" valign="top" style="padding:13px; padding-top:15PX; border:1px solid #46629e; background-color:#6c84b8; border-left:0px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <div id="helptext1" style="background-image:url(content/images/facebook_frame_coaching2_video_bg.png);
                        background-position:top; background-repeat:no-repeat; width:660px; height:474px; text-align:left;
                        position:absolute;top:265px;left:270px;display:none;z-index:90000">
                          ...
                          <div id="editor-nav">
                            <div class="editor-nav-panel rc-m">
                              <div class="editor-nav-panel-content"><a id="rm-content-launch"  href="#launch-content" style="width:180px;" class="nav-action-button rc-m rm-css-control-close" title="Edit text content"><img src="Content/images/edit_text_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Edit Text / Upload Video</a>
                      ...
                      <a  href="#launch-css" class="nav-action-button rc-m " title="Close full screen" onclick="window.self.close();">Close</a>-->
                             ...
                             <div id="editor-nav1" style="display:none;">
                            <div class="editor-nav-panel rc-m">
                              <div class="editor-nav-panel-content">
                              <a id="A2"  href="#launch-content" style="width:180px;" class="nav-action-button rc-m rm-css-control-close" title="Edit text content"><img src="Content/images/edit_text_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Download Basic Code</a>
                              <a id="A3"  href="javascript:;" style="width:180px;" class="nav-action-button rc-m rm-css-control-close" title="click here to activate move content" onclick="ShowImageUploadPopup();"><img src="Content/images/edit_text_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Upload Images</a>
                              <a id="A4"  href="javascript:;" style="width:180px; display:none;" class="nav-action-button rc-m rm-css-control-close" title="click here to de-activate move content" onclick="return MoveContent('0');"><img src="Content/images/edit_text_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />De-Activate Move Content</a>                              
                              <a href="javascript:;"  class="nav-action-button rc-m " style="width:180px;" title="Save CustomTab" id="A5" onclick="return OpenDivCustomTabName();" ><img src="Content/images/save_icon_sidebar.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Save</a>
                              <a href="javascript:;"  class="nav-action-button rc-m " style="width:180px;" title="Save CustomTab" id="A6" onclick="ShowCustomCodePopup();" ><img src="Content/images/save_icon_sidebar.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Paste Custom Code</a>
                              <a href="javascript:;"  class="nav-action-button rc-m " style="width:180px;" title="Share Custom Tab" id="A7" onclick="return OpenDivShareCustomTabName();" ><img src="Content/images/share_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Share</a>
                              <a href="javascript:;" class="nav-action-button rc-m " style="width:180px;" title="Publish CustomTab" id="A8"  onclick="showCustomisePages();"><img id="img2" src="Content/images/publish_custom_tab_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Publish Custom Tab</a>
                              <a href="javascript:;" class="nav-action-button rc-m " style="width:180px;" title="Publish CustomTab" id="btnRequestTabURL"  onclick="ShowRequestTabUrlPopup();"><img id="img4" src="Content/images/publish_custom_tab_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Get Tab Urls</a>
                              &nbsp;&nbsp; 
                              <a id="A9"  href="javascript:;" target="_parent" class="nav-action-button rc-m " style="width:180px;" title="Change Template for this Page." onclick="chkTemplatePage3('Warning! Please Save your work before leaving this page othrewise your changes will be discarded');"><img src="Content/images/change_template_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Change Template</a>
                              <a href="javascript:;" onclick="FacebookAlert();" style="width:180px;" class="nav-action-button rc-m " title="Reset selected template"><img src="Content/images/reset_icon.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Reset</a><a href="#" id="A10" runat="server" style="display:none" ></a> 
                               
                               
                                
                                <div style="padding-left:10px;"> <img id="img3" src="content/images/bigspinner.gif" style="display:none" /> </div>
                                <!-- <a href="http://www.picnik.com/app" target="_blank" class="nav-action-button rc-m " title="Crop Image" >Crop Image</a> 
                      <a  href="#launch-css" class="nav-action-button rc-m " title="Close full screen" onclick="window.self.close();">Close</a>-->
                              </div>
                            </div>
                ...
                <tr>
                  <td align="left" valign="top" style="padding:13px; padding-top:15PX; border:1px solid #46629e; background-color:#6c84b8; border-left:0px; color:#FFFFFF"><span id="spnAssigned" runat="server"></span><br /></td>
                </tr>
                <tr>
                  <td height="20" align="center" valign="top"><img src="Content/images/sidebar_arrow_down.png" width="23" height="12" /></td>
                </tr>
				...
				<div style="height:auto;" id="dvTabMainDiv" runat="server">
        ...
        html,body{padding:0px;margin:0px;background-color: transparent;}.SafariBgFix{background-repeat:no-repeat;}
                  ...
                  <br />
                   <div id="divSidebarHtml" runat="server" style="text-align:center; margin:0 auto;  " align="center"  ></div>  <div id="div1" runat="server" style="text-align:center; margin:0 auto;  " align="center"  ></div>
                </div>
              </div>
            <!-- Left Template end -->
			</div>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="left" valign="top" class="greypopupborder" style="padding:13px; padding-bottom:16px; padding-right:0px;"><table cellpadding="0" cellspacing="0" border="0" width="100%">
                                  ...
                                  <ItemTemplate>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr height="30" align="center">
                                        <td><input class="checkboxpadding" type="radio" id="chkPage" name="chkPage" runat="server" pageid='<%#Eval("Id")%>'  pagelink='<%#Eval("link")%>'  group="pages" onclick='Pageid(this);'  pageaccess_token='<%#Eval("access_token")%>' pagevalue='<%#Eval("name")%>' pageimage='<%#Eval("picture")%>' />
                                          <%#Eval("name")%>
                                          ...
                                          <input type="hidden" id="hdnLink" runat="server" value='<%#Eval("link")%>' />
                                        </td>
                                        <td >&nbsp;</td>
                                      </tr>
                                    </table>
                        ...
                        <tr>
                          <td height="20" align="left" valign="middle" style="padding-top:10px;"><a id="btnSave" class="bluetablink" runat="server" onclick="return ValidatePublish();" title="Publish Custom Tab">Publish Custom Tab</a> <a id="btnUpload" runat="server" style="display:none">Publish Custom Tab</a>&nbsp;<a id="lnkDownload" class="bluetablink" runat="server" title="Download Sidebar" style="display:none;">Download Sidebar</a></td>
                        </tr>
                      </table></td>
                  </tr>
                </table>
  ...
  <tr>
    <td align="left" valign="top"><table cellpadding="0" cellspacing="0" border="0" width="100%">
                      <tr bordercolor="#cccccc;" style="height:25px;">
                        <td height="30" valign="top" class="arial16gray"><b>Upload Custom Tab Images</b> </td>
                      ...
                      <tr>
                        <td colspan="2" valign="top"><div style="overflow:auto; background-color:#ffffff; padding:15px; border:1px solid #cccccc;">
                          <table cellpadding="0" cellspacing="2" border="0" width="100%">
                            ...
                            <tr>
                              <td width="95" align="right" valign="middle">Upload Image 1:</td>
                              <td align="left" valign="middle">
                                <input type="file" runat="server" id="flimg1" onChange="readURL(this);"  />
                                &nbsp;<span class="SmallText">(jpg, jpeg, bmp, gif files only)</span>
                                </td>
                              </tr>
                            <tr>
                              <td></td>
                              <td align="left" valign="middle"><div style="padding-top:5px; padding-bottom:5px; color:#707070"><asp:Label id="lblimg1" runat="server" Visible="false" ></asp:Label></div></td>
                            </tr>
                            <tr>
                              <td  width="95" align="right" valign="middle">Upload Image 2:&nbsp;</td>
                              <td align="left" valign="middle">
                            ...
                            <tr>
                              <td></td>
                              <td align="left" valign="middle"><div style="padding-top:5px; padding-bottom:5px;  color:#707070"><asp:Label id="lblimg2" runat="server" ></asp:Label></div></td>
                            </tr>
                            <tr>
                              <td width="95" align="right" valign="middle">Upload Image 3:&nbsp;</td>
                              <td align="left" valign="middle">
                            ...
                            <tr>
                              <td></td>
                              <td align="left" valign="middle"><div style="padding-top:5px; padding-bottom:5px; color:#707070"><asp:Label id="lblimg3" runat="server"></asp:Label></div></td>
                            </tr>
                            <tr>
                              <td  width="95" align="right" valign="middle">Upload Image 4:&nbsp;</td>
                              <td align="left" valign="middle">
                            ...
                            <tr>
                              <td></td>
                              <td align="left" valign="middle"><div style="padding-top:5px; padding-bottom:5px; color:#707070"> <asp:Label id="lblimg4" runat="server"></asp:Label></div></td>
                            </tr>
                            <tr>
                              <td width="95" align="right" valign="middle" >Upload Image 5:&nbsp;</td>
                              <td align="left" valign="middle">
                            ...
                            <tr>
                              <td></td>
                              <td align="left" valign="middle"><div style="padding-top:5px; padding-bottom:5px; color:#707070"> <asp:Label id="lblimg5" runat="server"></asp:Label></div></td>
                            </tr>
 ...
 <tr>
    ...
    <strong>Disclaimers : </strong> Please ensure the image you upload is 1 MB or less &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;" id="SaveTabImages" class="bluetablink" runat="server">Save Images</a></td>
  </tr>
</table>
...
<div id="GetPublishTabURLDiv" class="popupbg" style="display:none ; position:absolute; z-index: 1000;  width: 535px;">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="left" valign="top"><table cellpadding="0" cellspacing="0" border="0" width="100%">
                      <tr bordercolor="#cccccc;" style="height:25px;">
                        <td height="30" valign="top" class="arial16gray"><b>Get Tab URL</b> </td>
                        <td align="right" valign="top"><a href="javascript:;" onClick="HideRequestTabUrlPopup();">Close</a>&nbsp;&nbsp;&nbsp; </td>
                      </tr>
                      <tr>
                        <td colspan="2" valign="top"><div style="overflow:auto; background-color:#ffffff; padding:15px; border:1px solid #cccccc;">
                          <table cellpadding="0" cellspacing="2" border="0" width="100%">
                            ...
                            <tr>
                              <td  align="left" valign="middle">Facebook URL:</td>
                              <td align="left" valign="middle">
                             <a href="javascript:;" id="lblfburl" target="_blank"></a> 
                                                         </td>
                            </tr>
                            <tr><td>  <br /></td></tr>
                            <tr>
                              <td   height="15" align="left" valign="middle">Summa-Social Website URL:&nbsp;</td>
                              <td  height="15" align="left" valign="middle">
                             <a href="javascript:" id="lblsummaurl" target="_blank"></a> 
                                                       </td>
                            </tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
      <tr>
        <td height="30" width="90" align="left" valign="top" class="arial16gray"><strong>Paste your HTML &amp; JS Code here:</strong><div style="float:right; font-size:12px; padding-top:5px;"><a href="javascript:;" onclick="HideCustomCodePopup();">Close</a></div></td>
       </tr>
      <tr>
        <td align="left" valign="top">
      ...
      <tr>
        <td align="right" valign="top" style="border-bottom:1px solid #d9dbde; padding-bottom:20px;"><a href="javascript:;" id="SaveCode" class="bluetablink" onclick="SavePasteCode();">Save and Close</a></td>
      </tr>
      <tr>
        <td align="left" valign="top">&nbsp;</td>
      </tr>
      <tr>
        <td align="left" valign="top" style="line-height:18px;"><strong>Disclaimers:</strong><br />          
        1.Total Social Media is uable to fix any errors produced by html/js code uploaded by users<br />
        2.Users agrees  to assure all liability by publishing this tab <br />
    ...
    <div class="main_box_hover_mid_left_shadow2">
      <div class="main_box_hover_mid_right_shadow2">
        <div class="main_box_hover_mid_inn2">
          <div class="main_box_hover_mid_inn_hd3" style="font-size:13px; font-family:arial, Geneva, sans-serif; width:416px padding-left:8px;">Warning! Please save your work before leaving this page.</div>
...
$("div[rel^=rrm-css-bg]").click(function (e) {
    ...
    */
    ...
    $("div[rel^=video]").click(function (e) {
        ...
        /*form = '<div style="font-size:16px"><b>Enter YouTube URL : </b><br><br> <input type="text" id="videourl" value=""  size="38" style="font-size:16px"/> <input type="button" value="Upload" onClick="' + func + '(document.getElementById(\'videourl\').value,\'' + id + '\');fboxhide();" /> <input type="button" value="Remove" onClick="' + func + 'reset(\'' + id + '\');"> </div>';*/
	...
	$(".urlandtextwithhide").click(function (e) {
        ...
        func = 'seturlandtextwithhide';
        form = '<div style="font-size:16px"><b>Edit Text : </b><br><br><input type="text" onKeyUp="$(\'#' + id + '\').html(nl2br(this.value))" value="' + $(this).html() + '"  size="38" style="font-size:16px"/> <br><br></div><div style="font-size:16px"><b>Enter Website URL : </b><br><br><input type="text" id="urlandtextwithhide" value="' + url + '"  size="38" style="font-size:16px"/><div style="float:left; padding-top:10px; font-size:10px; font-family:Arial, Helvetica, sans-serif;"><b>Note:</b>Please note that using http instead of https will result in a security warning. If available, use https instead.</div><br/><br/><br/><div style=" border-top: 1px solid #DDDDDD; padding-top: 5px; margin-top: 10px; text-align: right; padding-bottom:5px;"><div style="padding-top:5px; text-align:left; float:left"> Hide: <input type="checkbox" onClick="seturlandtextimagehide(\'' + $(".urlandtextwithhide").index(this) + '\',this.checked);" /></div><div style="padding-top:5px;"><a href="javascript:;" class="bluetablink" onClick="' + func + '(document.getElementById(\'urlandtextwithhide\').value,\'' + $(".urlandtextwithhide").index(this) + '\');fboxhide()" ;>Save and Close</a></div></div></div>';
...
function seturlandtextimagehide(index, bol) {
        if (bol) {
            $(".btnhide:eq(" + index + ")").css('display', 'none');
        }
        else {
            $(".btnhide:eq(" + index + ")").css('display', '');
        }
    }
...
//		$(".url:eq(" + index + ")").attr('rel', url);
	...
	function seturlandtextwithhide(url, index) {

		//$(".url:eq("+index+")").removeAttr('onclick');
		var str = 'setLocation(\'' + url + '\');'
        $(".urlandtextwithhide:eq(" + index + ")").attr('rel', url);
		$(".urlandtextwithhide:eq(" + index + ")").attr('onClick', str);
       // $(".url:eq(" + index + ")").attr('onClick', str);
//		$(".url:eq(" + index + ")").attr('rel', url);
