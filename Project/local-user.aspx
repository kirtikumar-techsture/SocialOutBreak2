<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="local-user.aspx.vb" Inherits="tsma.localuser" %>
                                    ...
                                    <tr>
                                      <td class="menubg" valign="top"><table cellpadding="0" cellspacing="0" border="0" width="100%">
                                          ...
                                          <input type="hidden" id="hdnid" value="0" />
                                           ...
                                           <ItemTemplate>
                                          <tr>
                                            <td  height="38" group="company" align="left" valign="middle" show="0" onMouseOver="AddClass(this);" onMouseOut="RemoveClass(this)" style="font-family:arial; font-size:14px; padding-left:15px; padding-right:15px; color:#FFF; cursor:pointer;" bit='<%# Container.DataItem("c_ispasswordRequired")%>' image='<%# Container.DataItem("c_Icon")%>' companyid='<%# Container.DataItem("c_id")%>' onClick="GetPosition(this);" companyname='<%# Container.DataItem("c_Name")%>' cssstyle='<%# Container.DataItem("c_Style")%>'><span id="spnCompany"><img src="../../Content/adminuploads/<%# Container.DataItem("c_Icon")%>" align="absmiddle"/>&nbsp;&nbsp; <%# Container.DataItem("c_Name")%> </span><br />                                            </td>
                                          </tr>
                                          </ItemTemplate>
                                         </asp:Repeater>
                                          <tr>
                  ...
                  <tr>
                    <td align="left" valign="top"  style="padding-top:10px;" ><table width="100%" border="0" cellspacing="0" cellpadding="2" >
                      <tr>
                        ...
                        <td width="54%" align="left" valign="middle"><a href="javascript:;" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image15','','../../Content/images/facebook_icon_hover.png',1)"><img src="Content/images/facebook_home_hover.png" onClick="javascript:MM_openBrWindow(1); " width="36" height="34" border="0" align="absmiddle" /></a></td>
                      </tr>
                      <tr>
    ...
    <tr>
        ...
        We Will Send Your Password Soon.
          ...
          <tr style="display:none;">
            <td class="bannerborder"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left" valign="top" class="stepbg">&nbsp;</td>
