...
Public Class sweepstake_content
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        FBAPPID = System.Configuration.ConfigurationManager.AppSettings("SweepStakeFBAPI").ToString
        Dim fbappname As String = System.Configuration.ConfigurationManager.AppSettings("SweepStakeFBAPIName").ToString
