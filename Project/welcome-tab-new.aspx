<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="welcome-tab-new.aspx.vb" Inherits="tsma.welcome_tab_new" %>
...
<script>
    window.fbAsyncInit = function () {
        FB.init({
			...
			//appId: '240679536044730', //for summa welecome tab new
...
<script type="text/javascript" charset="utf-8">
   ...
   <div id="divContent" style="width:810px; margin-left:auto; margin-right:auto; text-align:center;" align="center" runat="server"></div>
    </form>
...
<script type="text/javascript">
    ...
    $('#playvideo2').click(function () {
        ...
        $("#Youtube2").attr('src', 'https://www.youtube.com/embed/JV8A7E48HR4?autoplay=1&cc_load_policy=1');
    })
