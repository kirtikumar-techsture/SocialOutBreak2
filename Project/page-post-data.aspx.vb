    ...
    Private Sub btnGet_Click(sender As Object, e As System.EventArgs) Handles btnGet.Click
        ...
        For Each dtRow As DataRow In ds.Tables(0).Rows
            Try
                ...
                url = "https://graph.facebook.com/{0}/promotable_posts?is_published=false&app_id=224415534331837&access_token={1}"
                ...
                Else
                    For Each item As PostData.m_data In postData
                        ...
                        Catch ex As Exception
                            ...
                            dataAccess1.AddParam("@e_ErrorFrom", SqlDbType.VarChar, "Submitting posted data into DB from facebook")
                            dataAccess1.ExecuteNonQuery()
                        End Try
                    Next
                End If
    ...
    Private Sub btnDeletePost_Click(sender As Object, e As System.EventArgs) Handles btnDeletePost.Click
        ...
        For Each dtRow As DataRow In ds.Tables(0).Rows
            Try
                ...
                args1("access_token") = dtRow("token")
                args1("uid") = dtRow("pageid")
                fb.Delete(dtRow("postid"), args1)
