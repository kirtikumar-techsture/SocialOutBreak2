...
<script type="text/javascript">
    ...
    function ShareAlert(mess) {
        //$("#spnMessage").html(mess);
        $("#DivShareCoverPhoto").show("slow");
    }
    function HideShareAlert() {
        $("#DivShareCoverPhoto").hide("slow");
    }
...
<tr>
  ...
  <div class="watch_video_tut_box" style="padding-top:10px; padding-left:130px;">
			  ...
			  <div id="popup_container1" style="width:450px; height:80px;"  >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Your work has been saved<br/><br/>
                   <input type="button" class="inputbutton" onclick="HideSaveAlert();" value="Close" id="lnkRedirect" runat="server" />
				</div>
			 </div>
</div>
			  ...
			  <div id="popup_container1" style="width:450px; height:80px;"  >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Cover Photo Shared Successfully<br/><br/>
                   <input type="button" class="inputbutton" onclick="HideShareAlert();" value="Close" id="lnkRedirectShare" runat="server" />
				</div>
			 </div>
</div>
			  ...
			  <div id="popup_container1" style="width:450px; height:80px;" >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Cover Photo Name:  <input type="text" runat="server" id="txtCoverPhotoName" width="100" height="20" /><br/><br/>
                   <a href="javascript:;" class="bluetablink" onclick='HideCoverPhotoNameAlert();'>Save</a>&nbsp;&nbsp;
                     <a href="javascript:;" class="bluetablink" onclick='$("#DivCoverPhotoName").hide("slow");'>Cancel</a>
				</div>
			 </div>
</div>
