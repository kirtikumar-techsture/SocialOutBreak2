...
<body>
    ...
    <div id="DivSaveCoverPhoto" style="width:100%; height:750px;; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:10000000; text-align:center;padding-top:200px; padding-left:170px; display:none;">
    ...
    <div id="DivCopyCoverPhoto" style="width:100%; height:750px;; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:10000000; text-align:center;padding-top:200px; padding-left:170px; display:none;">
  ...
  <tr>
    ...
    <td align="left" valign="top" style="padding-top:20px;"><table width="242" border="0" cellspacing="0" cellpadding="0">
          <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top" class="facebookboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td height="140" align="center" valign="middle" class="facebookboxwhite"><asp:Panel id="pnlCoverPhoto" runat="server"> <a href="<%=ResolveUrl("create-cover-photo")%>"> <img src="" name="imgtop" width="400" height="100" border="0" id="imgtop" runat="server" /> </a> 
                          </asp:Panel>
              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
					...
					<a href='javascript:;' onclick="RedirectCustomise();" ><img src="" id="imgMyCoverPhoto" runat="server" width="400" height="100" border="0" /></a>
