        ...
        <td style="border:1px solid #bdc7d8; background-color:#FFF; padding-left:20px;">                <div id="editor-nav">
          <div class="editor-nav-panel rc-m">
            <div class="editor-nav-panel-content">
              ...
              <a id="ch_temp"  href="javascript:;" target="_parent" class="nav-action-button rc-m " title="Change Template for this Page." onclick="chkTemplatePage3('Warning! Please Save your work befor leave this page othrewise your changes will be discarded');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Change Template</a><a id="lnkResize" runat="server" href="javascript:;" target="_parent" class="nav-action-button rc-m " title="Crop Image" onclick="PopupCenter('crop2.aspx', 'Resize','800','700');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Crop Image</a>
              ...
              <a id="lnkShare"  href="javascript:;" target="_parent" class="nav-action-button rc-m " title="Share Cover Photo" onclick="$('#DivCoverPhotoUserEmail').show('slow');"><img src="Content/images/arrow_round_gray.png" width="15" height="15" align="absmiddle" style="margin-right:7px;"  />Share With User</a>
