<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sweepstakes-leads.aspx.vb" Inherits="tsma.leads" %>
...
<ContentTemplate>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <div align="left" style="float:left"><h6>My Sweepstakes Leads</h6></div>
                <div align="right" style="float:right; margin-right:20px;"><a href="sweepstakes-leads-admin" class="bluetablink">Back</a></div>
                </td>
              </tr>              
              <tr>
