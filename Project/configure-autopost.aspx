<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="configure-autopost.aspx.vb" Inherits="tsma.configure_autopost" %>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="left" valign="top" class="contentbody" style="padding-left:10px; padding-right:10px;"><div style="padding-bottom:10px;">
              ...
              <span style="float:left;font-family: Tahoma, Geneva, sans-serifthaoma;font-size: 16px;color: #181818;margin:0px;font-weight:bold;line-height:18px;">Set Daily Autopost</span>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
             ...
             <div id="divAutoPostDaySelection" align="center" style="display:none; position:relative; float:left; left:42px; width:650px; height:500px; margin:0 auto;  border:0px solid #ff0000;">
                ...
                <tr>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" style="text-align:center">
                      <tr bordercolor="#cccccc;" style="height:25px;">
                        <td valign="middle" style="display:none"><b>Save Auto Post Day Selection</b> </td>
                        <td align="right" valign="middle" ><a href="javascript:;" onClick="HideAutopostDaySelection();">[Close]</a>&nbsp;&nbsp;&nbsp; </td>
                      </tr>
                      <tr>
                        ...
                        <div style="width:650px; overflow:auto; background-color:#f3f3f3; padding:15px; border:1px solid #cccccc;">
                          ...
                          <input type="radio" id="rd7day" name="autopost7day" runat="server"  group="autopost7day"  />
                      ...
                      <tr>
                        ...
                        <a href="javascript:;" id="csswdetail" class="bluetablink"  onclick="ValidateCustomiseUserMessage();">Save  </a>&nbsp;
             ...
             <div id="divAutopostParticularDay" align="center" style="display:none; position:relative; float:left; left:42px; width:650px; height:500px; margin:0 auto;  border:0px solid #ff0000;">
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" style="text-align:center">
                      ...
                      <tr>
                        ...
                        <div style="width:650px; overflow:auto; background-color:#f3f3f3; padding:15px; border:1px solid #cccccc;">
                          ...
                          <tr>
                          <td  width="15" align="left" valign="middle" ><input class="checkboxpadding" runat="server" type="checkbox" id="autopostday1" name="chksingleday" group="chksingleday" /></td>
                          <td width="65" align="left" valign="middle">Monday</td>
                          
                        </tr>
                        
                          <tr>
                          <td  width="15" align="left" valign="middle" ><input class="checkboxpadding" runat="server" type="checkbox" id="autopostday2" name="chksingleday" group="chksingleday" /></td>
                          <td width="65" align="left" valign="middle">Tuesday</td>
                          
                        </tr>
                        
                          <tr>
                          <td  width="15" align="left" valign="middle" ><input class="checkboxpadding" runat="server"  type="checkbox" id="autopostday3" name="chksingleday" group="chksingleday" /></td>
                          <td width="65" align="left" valign="middle">Wedenesday</td>
                          
                        </tr>
                        
                          <tr>
                          <td  width="15" align="left" valign="middle" ><input class="checkboxpadding" runat="server" type="checkbox" id="autopostday4" name="chksingleday" group="chksingleday" /></td>
                          <td width="65" align="left" valign="middle">Thursday</td>
                          
                        </tr>
                        
                          <tr>
                          <td  width="15" align="left" valign="middle" ><input class="checkboxpadding"  runat="server" type="checkbox" id="autopostday5" name="chksingleday"  group="chksingleday" /></td>
                          <td width="65" align="left" valign="middle">Friday</td>
                          
                        </tr>
                        
                          <tr>
                          <td  width="15" align="left" valign="middle" ><input class="checkboxpadding" runat="server" type="checkbox" id="autopostday6" name="chksingleday"  group="chksingleday" /></td>
                          <td width="65" align="left" valign="middle">Saturday</td>
                          
                        </tr>
                        
                        <tr>
                          <td  width="15" align="left" valign="middle" ><input class="checkboxpadding" runat="server" type="checkbox" id="autopostday7" name="chksingleday"   group="chksingleday" /></td>
                       ...
                       <!-- <asp:UpdatePanel ID="UpdatePanelDiv5" runat="server" UpdateMode="Conditional">
                        ...
                        <div  align="right" style="float:right; ">
                         <a href="javascript:;" class="bluetablink" style="display:none;" id="lnkdisableImport1">Loading...</a>
                              ...
                              <a href="javascript:;" class="bluetablink" runat="server" style="display:none;"  onclick="return confirmClear();" id="lnkClearAll">Clear All</a>
                              </asp:PlaceHolder>
                         </div>
                        </div>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="right" valign="middle"><asp:LinkButton OnCommand="AddLibToAutoPost" 
                                                                    onclientclick="return PromtAddToautoPost();" CommandArgument='<%#Eval("lib_Id")%>' CommandName='<%#Eval("lib_Id")%>' id="lnkAddLibtoAutoPost" CssClass="bluetablink" runat="server" Visible="false"><asp:PlaceHolder ID="plhNotAdded" runat="server" Visible="false">
