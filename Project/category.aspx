<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="category.aspx.vb" Inherits="tsma.category" %>
          ...
          <tr>
            <td align="left" valign="top" class="facebookboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
				...
				<a href="tabs-list.aspx?cid=<%=Convert.ToString(request("id"))%>" class="bluetablink">DESIGN A CUSTOM TAB</a></td>
              </tr>
              <tr>
                ...
                <img id="imgtop" runat="server" src="Content/images/customtab/template0_bg.jpg" width="150" height="300" border="0" />
                </a>
                </asp:Panel>
                <asp:Label ID="lblNoSidebar1" runat="server" Visible="false" Font-Bold="true">No Custom Tab Templates Available</asp:Label>
                </td>
              </tr>
            </table></td>
          </tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                   ...
                   <asp:Literal ID="ltrName" runat="server"></asp:Literal><br /><br />
					<a href='javascript:;' onclick="RedirectCustomise();" ><img src="" id="imgMyCustomTab" runat="server" width="150" height="300"/></a> 
                   ...
                   <input type="hidden" id="hdnIsCustomise" runat="server" value="0" />
...
function RedirectCustomise() {
        document.location.href = 'selected-tab.aspx?ctId=' + $('#hdnMasterId').val() +'&cid=' + <%=request("id")%> +'&isCustomise=' + $('#hdnIsCustomise').val();
}
