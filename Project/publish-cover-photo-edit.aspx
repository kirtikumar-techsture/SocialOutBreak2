    ...
    <div id="DivSaveCoverPhoto" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:10000000; text-align:center;  display:none;">
			  <div id="popup_container1" >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Cover Photo published to your page(s) successfully<br/><br/>
...
<table width="700px"  border="0" cellspacing="0" cellpadding="0" style="padding-top:10px;">
  ...
  <tr>
    ...
    <a onclick="ValidatePublishCoverPhoto();" title="Publish Cover Photo" href="javascript:;"  class="bluetablink" >Publish Cover Photo&nbsp;&nbsp;</a>
    <a title="Edit Cover Photo" href="cover-photo-selection-edit.aspx?cpId=<%=Session("CoverPhotoID")%>&userId=<%=Session("SiteUserId")%>&FbuserId=<%=Session("FacebookUserId")%>&CId=<%=tsma.GetSetCookies.GetCookie("CompanyId") %>&IId=<%=tsma.GetSetCookies.GetCookie("IndustryId") %>"  class="bluetablink" >Go Back to Edit Cover Photo&nbsp;</a>
