        ...
        <div style="float:left">
          ...
          <div id="rm-css-bgimage-control" class="rm-css-bgimage-control" style="z-index:1000">
            <form class="rm-widget disabled" id="bgimage-upload" method="post" action="#">
              <input style="display:;" id="rm-css-bgimage-uploader" name="rm-image" width="200" type="file" height="18">
              <div style="position:absolute; top:0px; z-index:1000000" >
                <object style="visibility: visible;" id="rm-css-bgimage-uploaderUploader" data="/uploadify.swf" type="application/x-shockwave-flash" width="0" height="18">
...
<div style="float:right; width:65px; margin-top:45px;">
  <a style="display: inline-block;position:absolute;margin-left:-280px;margin-top:-40px;font-family:'Times New Roman', Times, serif;font-size:14px;color:grey;" href="#cancel" id="rm-css-control-cancel" title="Undo latest changes for this element?"><strong>Undo Changes</strong></a>
  
 <a href="#" id="rm-css-control-close" style="position:absolute;margin-left:-50px;margin-top:-40px" title="Close Visual Editor"><img src="content/facebox/closelabel1.gif" border="0" /></a></div>
