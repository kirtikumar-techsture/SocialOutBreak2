<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="view-all-leads.aspx.vb" Inherits="tsma.view_all_leads" %>
...
<ContentTemplate>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="30" align="left" valign="top"> <span style="float:left;font-family: Tahoma, Geneva, sans-serifthaoma;font-size: 16px;color: #181818;margin:0px;font-weight:bold;line-height:18px;">My Custom Tab/Sweepstake Leads</span>
