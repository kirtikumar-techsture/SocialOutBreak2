...
<link rel="stylesheet" href="../Content/css/jquery-ui-1.8.17.custom.css" type="text/css" />
...
<div id="DivSaveBeforeExistCover" style="width:100%; height:100%; text-align:center;  background-image:url(Content/facebookalert/images/popup_bg.png);  position:absolute; z-index:999999999; display:none;">
			  <div id="popup_container_Save" style="width:450px; height:80px;"  >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Warning: You have unsaved changes to your work you are editing.<br/><br/>
                   <input type="button" class="inputbutton" onclick="ChangedPage1();" value="Don't Save" id="popup_save" style="cursor:pointer"/>&nbsp;&nbsp;
                   <input type="button" class="inputbutton" onclick="HideLinkAlert1();" value="Save" id="popup_close" style="cursor:pointer"/>
				</div>
			 </div>
			 </div>      
<div id="DivSaveBeforeExistTab" style="width:100%; height:100%; text-align:center;  background-image:url(Content/facebookalert/images/popup_bg.png);  position:absolute; z-index:999999999; display:none;">
			  <div id="popup_container_Save" style="width:450px; height:80px;"  >
			    <div id="popup_content" style="padding-top:10px; padding-left:20px; text-align:left">
                  Warning: You have unsaved changes to your work you are editing.<br/><br/>
                   <input type="button" class="inputbutton" onclick="ChangedPage2();" value="Don't Save" id="popup_save" style="cursor:pointer"/>&nbsp;&nbsp;
                   <input type="button" class="inputbutton" onclick="HideLinkAlert2();" value="Save" id="popup_close" style="cursor:pointer"/>
				</div>
			 </div>
			 </div>                    
<div id="homepagemaincenter">
  <input type="hidden" id="hdnSaveHeader" value="1"/>
<table width="1004" border="0" cellspacing="0" cellpadding="0" style="display:none">
  <tr>
    <td height="42" align="left" valign="middle" style="padding-right:25px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="middle"><img src='../Content/images/for_rent_logo.jpg' width="159" height="29" hspace="20" /></td>
        <td align="right" valign="middle" style="color:#FFF; font-size:18px;"> <a href='dashboard' style="color:#FFFFFF">Home</a>&nbsp;    |&nbsp; <a href='<%=ConfigurationManager.AppSettings("AppPath")%>SiteUserLogout.aspx' style="color:#FFFFFF"> Logout </a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <img src='../Content/images/for_rent_apartment_header_new.jpg' width="1004" height="217" style="display:none"/>
  ...
  <tr>
    <td height="37" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="top" style="font-size:18px; padding-left:25px;"><font color="#636363">Welcome</font><span class="selecttitle"><%=tsma.GetSetCookies.GetCookie("SelectedName")%></span></td>
        ...
        <td width="20" align="right" valign="middle" style="font-size:18px; padding-right:25px;"><img src='../Content/images/select_a_network.jpg' border="0"/></td>
      </tr>
    </table></td>
  </tr>
</table>
...
<div id="toppart">
  <div id="topright"><a href='<%=ConfigurationManager.AppSettings("AppPath")%>dashboard' style="color:#FFFFFF">Home</a>&nbsp;    |&nbsp; <a href='<%=ConfigurationManager.AppSettings("AppPath")%>express-customtab' style="color:#FFFFFF">Express Setup</a>&nbsp;    |&nbsp; <a href='<%=ConfigurationManager.AppSettings("AppPath")%>SiteUserLogout.aspx' style="color:#FFFFFF"> Logout </a>(<font color="#c4f7ff"><%=Convert.ToString(Session("SiteUserName"))%></font>) </div>
</div>
<div id="inheaderimg"></div>
<div id="youselect">
<div style="padding-top:7px; padding-left:10px;"><font color="#636363">Welcome</font><span class="selecttitle"><%= Convert.ToString(Session("FacebookUserName"))%></span></div>
  <div id="selecte" style="position:absolute; display:none">
    <asp:PlaceHolder id="plcIndustry" runat="server" Visible="true"> <span id="spnChooseInd" style="cursor:pointer;"> <strong class="arial14"><font color="#FFFFFF">You Selected:&nbsp;</font></strong><img src='../Content/images/youselect_arrow_down.png' width="11" height="6" align="absmiddle" group="arrow" border="0px" style=" margin-right:35px;" /> </span> </asp:PlaceHolder>
    <asp:PlaceHolder id="plcCompany" runat="server" Visible="false"> <span id="spnChoose" style="cursor:pointer;"> <strong class="arial14"><font color="#FFFFFF">You Selected:</font></strong> <img src='../Content/images/youselect_arrow_down.png' width="11" height="6" align="absmiddle" group="arrow" border="0" style="margin-left:10px; margin-right:35px;" /></span> 
    </asp:PlaceHolder>
