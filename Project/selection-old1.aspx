  ...
  <div id="centermain" style="height:2500px;">
          ...
          <div id="DivCustomTabName" style="width:100%; height:100%; text-align:center; background-image:url(Content/facebookalert/images/popup_bg.png); position:absolute; z-index:999999999; text-align:center;  display:none;">
            <div id="popup_container1" style="width:450px; height:80px;" >
              ...
              Custom Tab Name:
                ...
                <br/>
                <br/>
                <a href="javascript:;" id="lnkSave" runat="server" class="bluetablink" onclick="return SaveCustomTab();">Save</a>&nbsp;&nbsp;<a href="#" id="lnkClose" runat="server" style="display:" class="bluetablink" onclick='$("#DivCustomTabName").hide("slow");'>Cancel</a> </div>
            </div>
          </div>
	...
	line-height:18px; text-align:center">&nbsp;<br />
        ...
        html,body{padding:0px;margin:0px;background-color: transparent;}.SafariBgFix{background-repeat:no-repeat;}
			...
			<table align="right" width="240" border="1" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="20" style="text-align:right; vertical-align:middle;" ><img src="Content/images/sidebar_arrow_left.png" width="33" height="99"></td>
                  <td align="left" valign="top" style="padding:13px; padding-top:15PX; border:1px solid #46629e; background-color:#6c84b8; border-left:0px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="center"><table border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="66" valign="middle"><img src="Content/images/edit_mode_icon.png" width="57" height="57" /></td>
                            <td valign="middle" style="font-size:22px; font-weight:bold; color:#FFFFFF ">Edit Mode</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td align="center" style="vertical-align:middle; line-height:17px; text-align:left; color:#FFFFFF; padding-top:10px; padding-bottom:10px; text-align:center">To edit the text, click the Edit Text button.  To customize the background and color or add an image, click the Edit Color & Images button.  Text may look a little different on download.</td>
                      </tr>
                      <tr>
                        <td height="40" align="center" valign="top"><a href="#" title="Watch Video Tutorial" onclick="$('#helptext1').fadeIn();"><img src="Content/images/watch_video_tutorial.gif" width="158" height="24" /></a></td>
                      </tr>
                      <tr>
