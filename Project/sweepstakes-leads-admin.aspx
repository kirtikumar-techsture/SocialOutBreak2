<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sweepstakes-leads-admin.aspx.vb" Inherits="tsma.admin_view_lead" %>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top" class="contentbody"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td align="left" valign="top" style="padding-bottom:10px;"> <span style="float:left;font-family: Tahoma, Geneva, sans-serifthaoma;font-size: 16px;color: #181818;margin:0px;font-weight:bold;line-height:18px;">Set Notifications For Sweepstakes</span>
                                      ...
                                      <asp:Repeater ID="rptPages" runat="server">
                                        <headertemplate>
                                          <tr  style="font-weight:bold;background-color:#DCE6F1;"  align="Center"  Font-Bold="true" >
                                            ...
                                            <td align="center" width="40" style="color:#000000;" >#Leads</td>                                            
                                            <td align="center" width="70" style="color:#000000;" >View Leads</td>
                                        ...
                                        <itemtemplate>
                                          <tr align="left" valign="middle" onMouseOver="javascript:this.style.backgroundColor='#ECECEC'"  onMouseOut="javascript:this.style.backgroundColor='#FFFFFF'"  >
                                           ...
                                           <%-- <asp:PlaceHolder ID="PlaceHolder7" runat="server" Visible='<%#IIF(Eval("Leads")<>0,"true","false")%>'>
                                            ...
                                            <a href="sweepstakes-leads?lid=<%#Eval("Pageid")%>" class="bluetablink">View Leads</a>
                                            </asp:PlaceHolder>
                                         ...
                                         <alternatingitemtemplate>
                                          <tr align="left" valign="middle" style="background-color:#F7F7F9;" onMouseOver="javascript:this.style.backgroundColor='#ECECEC'" onMouseOut="javascript:this.style.backgroundColor='#F7F7F9'">
                                           ...
                                           <%-- <asp:PlaceHolder ID="PlaceHolder7" runat="server" Visible='<%#IIF(Eval("Leads")<>0,"true","false")%>'>
                                            ...
                                            <td align="center">
                                            <asp:PlaceHolder ID="PlaceHolder4" runat="server">
                                            <asp:LinkButton id="LinkButton1" runat="server" CssClass="bluetablink" OnCommand="SaveNotificationEmail" CommandName='<%#Eval("Pageid")%>' 
                                            OnClientClick="return ValidateEmail(this);" ToolTip="Click here to Save Notification Email">Save</asp:LinkButton>
                                            </asp:PlaceHolder> 
                                           <%-- <asp:PlaceHolder ID="PlaceHolder4" runat="server" Visible='<%#IIF(Eval("Leads")<>0,"true","false")%>'>
