...
Public Class tab_810
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            objCustomTab.FBApplicationId = strAppId 'ConfigurationManager.AppSettings("FBAppIdFor810Tab").ToString()
            ...
            hdnAppId.Value = ConfigurationManager.AppSettings("FBAppIdFor810Tab").ToString()
