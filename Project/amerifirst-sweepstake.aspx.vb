...
Imports System.IO
Public Class amerifirst_sweepstake
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        FBAPPID = System.Configuration.ConfigurationManager.AppSettings("AmerifirstSweepStakeFBAPI").ToString
        Dim fbappname As String = System.Configuration.ConfigurationManager.AppSettings("AmerifirstSweepStakeFBAPIName").ToString
        strlink = "http://www.facebook.com/" & stake.page.id
