    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Session("FacebookAccessToken") <> Nothing AndAlso Session("FacebookAccessToken") <> "" Then
                ...
                If Request.QueryString("cid") = 2 Or Request.QueryString("cid") = 4 Then
                    lnkCarousal.Visible = True
                Else
                    lnkCarousal.Visible = False
                End If
    ...
    Public Function BindCustomTab()
        Try
            If Session("FacebookAccessToken") <> Nothing AndAlso Session("FacebookAccessToken") <> "" Then
                ...
                objBAL.CategoryId = Convert.ToString(Request("cid"))
                ds = objBAL.GetSweepstakListByCompOrIndustry
                If ds.Tables(0).Rows.Count > 0 Then
                    rptCustomTab.DataSource = ds.Tables(0)
                    rptCustomTab.DataBind()
                Else
                    lblMessage.Text = "No Sweepstake Found"
                    plhCustomTab.Visible = False
