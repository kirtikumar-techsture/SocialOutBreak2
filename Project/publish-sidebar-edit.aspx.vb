        ...
        Try
            If Session("FacebookAccessToken") <> Nothing AndAlso Session("FacebookAccessToken") <> "" Then
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    Session("FanPageSelected") = ds.Tables(0).Rows(0).Item("sd_FBPageId").ToString
                    Session("FanPageName") = ds.Tables(0).Rows(0).Item("sd_FBPageName").ToString
                    'For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                    'Response.Write("Database Page ID : " & dstest.Tables(0).Rows(0).Item("sd_FBPageId").ToString)
                    If ds.Tables(0).Rows(0).Item("sd_IsPublished") = 1 Then
